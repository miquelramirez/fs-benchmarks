...
def extract_domain_name(task_filename):
    """ Tries to find the domain filename from the task filename """
...
def parse_args(task_filename=None, domain_filename=None):
    ...
    if not domain_filename:
        domain_filename = extract_domain_name(task_filename)
    return task_filename, domain_filename


def open(task_filename=None, domain_filename=None):
    task_filename, domain_filename = parse_args(task_filename, domain_filename)
