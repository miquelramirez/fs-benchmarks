(define (problem settlers) (:domain civ_fn)
 ...
 (:init (= (resource_use) 0) (= (labour) 0) (= (pollution) 0)
  (by_coast location0) (= (housing location0) 0)
  ...
  (by_coast location2) (metalliferous location2) (= (housing location2) 0)
  ...
  (connected_by_sea location2 location5) (connected_by_sea location5 location2)
...
(:bounds
 ...
 (:metric minimize
  (+ (+ (* 0 (pollution)) (* 1 (resource_use))) (* 1 (labour)))))
