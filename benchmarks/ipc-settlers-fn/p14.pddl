(define (problem settlers) (:domain civ_fn)
 ...
 (:init (= (resource_use) 0) (= (labour) 0) (= (pollution) 0)
  ...
  (mountain location2) (woodland location2) (= (housing location2) 0)
  ...
  (mountain location5) (woodland location5) (= (housing location5) 0)
  ...
  (by_coast location7) (= (housing location7) 0)
  ...
  (by_coast location8) (= (housing location8) 0)
 ...
 (:goal
  (and (connected_by_rail location7 location8)
       (connected_by_rail location8 location1)
       (connected_by_rail location1 location2)
       (connected_by_rail location7 location5)
       (connected_by_rail location5 location8)
       (has_coal_stack location3)
       (has_ironworks location5)
       (>= (housing location6) 2)
       (connected_by_rail location8 location2)
       (connected_by_rail location2 location6)
       (connected_by_rail location6 location5)
       (connected_by_rail location4 location8)
       (connected_by_rail location1 location3)
       (has_ironworks location0)
       (connected_by_rail location1 location6)
       (connected_by_rail location6 location8)
 ...
 (:metric minimize
  (+ (+ (* 3 (pollution)) (* 0 (resource_use))) (* 0 (labour)))))
