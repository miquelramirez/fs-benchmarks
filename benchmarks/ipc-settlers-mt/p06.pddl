(define (problem settlers) (:domain civ)
 ...
 (:init (= (resource-use) 0) (= (labour) 0) (= (pollution) 0)
  ...
  (= (available coal location1) 0) (mountain location2)
  ...
  (= (available coal location5) 0) (connected-by-land location0 location2)
  ...
  (connected-by-land location2 location5) (potential vehicle0)
  (potential vehicle1) (potential vehicle2) (potential vehicle3)
  (potential vehicle4) (potential vehicle5))
 (:goal
  (and (has-coal-stack location0)
 ...
 (:metric minimize
  (+ (+ (* 0 (pollution)) (* 2 (resource-use))) (* 0 (labour)))))
