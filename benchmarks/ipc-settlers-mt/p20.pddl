(define (problem settlers) (:domain civ)
 ...
 (:init (= (resource-use) 0) (= (labour) 0) (= (pollution) 0)
  (woodland location0) (by-coast location0) (= (housing location0) 0)
  ...
  (= (available coal location1) 0) (woodland location2) (by-coast location2)
  ...
  (mountain location3) (woodland location3) (by-coast location3)
  ...
  (by-coast location4) (= (housing location4) 0)
  ...
  (mountain location6) (woodland location6) (by-coast location6)
  ...
  (= (available coal location8) 0) (woodland location9) (by-coast location9)
  ...
  (by-coast location10) (= (housing location10) 0)
  ...
  (mountain location11) (woodland location11) (by-coast location11)
  ...
  (= (available coal location14) 0) (connected-by-land location0 location1)
  ...
  (connected-by-sea location0 location6) (connected-by-sea location6 location0)
  (connected-by-sea location0 location8) (connected-by-sea location8 location0)
  (connected-by-sea location0 location11)
  (connected-by-sea location11 location0)
  (connected-by-sea location6 location8) (connected-by-sea location8 location6)
  ...
  (connected-by-sea location2 location3) (connected-by-sea location3 location2)
  (connected-by-sea location4 location9) (connected-by-sea location9 location4)
  (connected-by-sea location4 location10)
  (connected-by-sea location10 location4)
  (connected-by-sea location9 location10)
  (connected-by-sea location10 location9) (potential vehicle0)
  (potential vehicle1) (potential vehicle2) (potential vehicle3)
  (potential vehicle4) (potential vehicle5) (potential vehicle6)
  (potential vehicle7) (potential vehicle8) (potential vehicle9))
 (:goal
 ...
 (:metric minimize
  (+ (+ (* 0 (pollution)) (* 0 (resource-use))) (* 0 (labour)))))
