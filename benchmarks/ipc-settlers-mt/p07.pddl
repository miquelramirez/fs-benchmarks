(define (problem settlers) (:domain civ)
 ...
 (:init (= (resource-use) 0) (= (labour) 0) (= (pollution) 0)
  (woodland location0) (by-coast location0) (metalliferous location0)
  ...
  (by-coast location1) (= (housing location1) 0)
  ...
  (mountain location2) (by-coast location2) (metalliferous location2)
  ...
  (= (available coal location2) 0) (woodland location3) (by-coast location3)
  ...
  (= (available coal location3) 0) (woodland location4) (by-coast location4)
  ...
  (= (available coal location6) 0) (connected-by-land location1 location0)
  ...
  (connected-by-sea location1 location4) (connected-by-sea location4 location1)
 ...
 (:goal
  (and (connected-by-rail location5 location2)
 ...
 (:metric minimize
  (+ (+ (* 2 (pollution)) (* 3 (resource-use))) (* 2 (labour)))))
