(define (problem settlers) (:domain civ)
 ...
 (:init (= (resource-use) 0) (= (labour) 0) (= (pollution) 0)
  ...
  (by-coast location7) (= (housing location7) 0)
  ...
  (by-coast location8) (= (housing location8) 0)
 ...
 (:goal
  (and (connected-by-rail location7 location8)
 ...
 (:metric minimize
  (+ (+ (* 3 (pollution)) (* 0 (resource-use))) (* 0 (labour)))))
