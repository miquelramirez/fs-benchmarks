(define (problem settlers) (:domain civ)
 ...
 (:init (= (resource-use) 0) (= (labour) 0) (= (pollution) 0)
  ...
  (woodland location1) (by-coast location1) (metalliferous location1)
  ...
  (= (available coal location6) 0) (woodland location7) (by-coast location7)
  ...
  (= (available coal location7) 0) (connected-by-land location0 location5)
  ...
  (connected-by-sea location6 location7) (connected-by-sea location7 location6)
  (connected-by-sea location0 location4) (connected-by-sea location4 location0)
 ...
 (:metric minimize
  (+ (+ (* 0 (pollution)) (* 0 (resource-use))) (* 2 (labour)))))
