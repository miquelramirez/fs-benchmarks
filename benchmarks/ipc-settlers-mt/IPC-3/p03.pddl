(define (problem settlers) (:domain civ)
 ...
 (:init (= (resource-use) 0) (= (labour) 0) (= (pollution) 0)
  ...
  (mountain location4) (woodland location4) (by-coast location4)
  ...
  (connected-by-sea location0 location2) (connected-by-sea location2 location0)
  ...
  (potential vehicle3) (potential vehicle4))
 (:goal
  (and (has-ironworks location3)
 ...
 (:metric minimize
  (+ (+ (* 0 (pollution)) (* 3 (resource-use))) (* 2 (labour)))))
