(define (problem settlers) (:domain civ)
 ...
 (:init (= (resource-use) 0) (= (labour) 0) (= (pollution) 0)
  ...
  (by-coast location2) (= (housing location2) 0)
  ...
  (woodland location3) (by-coast location3) (= (housing location3) 0)
  ...
  (mountain location5) (woodland location5) (by-coast location5)
  ...
  (= (available coal location7) 0) (connected-by-land location0 location4)
 ...
 (:metric minimize
  (+ (+ (* 1 (pollution)) (* 1 (resource-use))) (* 3 (labour)))))
