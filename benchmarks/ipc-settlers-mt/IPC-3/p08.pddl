(define (problem settlers) (:domain civ)
 ...
 (:init (= (resource-use) 0) (= (labour) 0) (= (pollution) 0)
  ...
  (= (available coal location6) 0) (connected-by-land location0 location2)
 ...
 (:metric minimize
  (+ (+ (* 2 (pollution)) (* 0 (resource-use))) (* 0 (labour)))))
