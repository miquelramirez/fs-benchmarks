(define (problem settlers) (:domain civ)
 ...
 (:init (= (resource-use) 0) (= (labour) 0) (= (pollution) 0)
  ...
  (mountain location8) (by-coast location8) (= (housing location8) 0)
  ...
  (woodland location9) (by-coast location9) (= (housing location9) 0)
  ...
  (connected-by-sea location2 location8) (connected-by-sea location8 location2)
 ...
 (:goal
  (and (connected-by-rail location7 location4)
 ...
 (:metric minimize
  (+ (+ (* 1 (pollution)) (* 3 (resource-use))) (* 1 (labour)))))
