(define (problem settlers) (:domain civ)
 ...
 (:init (= (resource-use) 0) (= (labour) 0) (= (pollution) 0)
  ...
  (= (available coal location0) 0) (by-coast location1)
  ...
  (by-coast location3) (= (housing location3) 0)
  ...
  (= (available coal location4) 0) (woodland location5) (by-coast location5)
  ...
  (= (available coal location5) 0) (connected-by-land location0 location1)
  ...
  (connected-by-sea location0 location3) (connected-by-sea location3 location0)
  (connected-by-sea location0 location5) (connected-by-sea location5 location0)
  (connected-by-sea location3 location5) (connected-by-sea location5 location3)
  (potential vehicle0) (potential vehicle1) (potential vehicle2)
  (potential vehicle3) (potential vehicle4) (potential vehicle5))
 (:goal
  (and (has-coal-stack location2)
       (>= (housing location3) 2)
 ...
 (:metric minimize
  (+ (+ (* 3 (pollution)) (* 2 (resource-use))) (* 0 (labour)))))
