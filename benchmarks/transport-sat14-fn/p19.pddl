...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p19.pddl
;; 
...
(define (problem p19)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-2-loc-25)
	(= (ploc package-2) city-2-loc-40)
	(= (ploc package-3) city-3-loc-35)
	(= (ploc package-4) city-2-loc-4)
	(= (ploc package-5) city-3-loc-33)
	(= (ploc package-6) city-2-loc-38)
	(= (ploc package-7) city-3-loc-5)
	(= (ploc package-8) city-2-loc-30)
	(= (ploc package-9) city-3-loc-46)
	(= (ploc package-10) city-2-loc-34)
	(= (ploc package-11) city-2-loc-41)
	(= (ploc package-12) city-1-loc-41)
	(= (ploc package-13) city-3-loc-52)
	(= (ploc package-14) city-3-loc-43)
	(= (ploc package-15) city-2-loc-37)
	(= (ploc package-16) city-1-loc-20)
	(= (ploc package-17) city-1-loc-53)
	(= (ploc package-18) city-2-loc-26)
	(= (ploc package-19) city-1-loc-7)
	(= (ploc package-20) city-1-loc-20)
	(= (ploc package-21) city-2-loc-35)
	(= (ploc package-22) city-2-loc-29)
	(= (ploc package-23) city-1-loc-31)
	(= (ploc package-24) city-2-loc-32)
	(= (ploc package-25) city-1-loc-44)
	)
  )
