...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p03.pddl
;; 
...
(define (problem p03)
  ...
  (:init
	...
	(= (vloc truck-1) city-loc-37)
	(= (vloc truck-3) city-loc-10)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-loc-31)
	(= (ploc package-2) city-loc-16)
	(= (ploc package-3) city-loc-11)
	(= (ploc package-4) city-loc-27)
	(= (ploc package-5) city-loc-28)
	(= (ploc package-6) city-loc-30)
	(= (ploc package-7) city-loc-4)
	(= (ploc package-8) city-loc-33)
	(= (ploc package-9) city-loc-36)
	(= (ploc package-10) city-loc-13)
	(= (ploc package-11) city-loc-49)
	(= (ploc package-12) city-loc-42)
	(= (ploc package-13) city-loc-44)
	(= (ploc package-14) city-loc-17)
	(= (ploc package-15) city-loc-6)
	(= (ploc package-16) city-loc-32)
	(= (ploc package-17) city-loc-45)
	(= (ploc package-18) city-loc-4)
	(= (ploc package-19) city-loc-15)
	(= (ploc package-20) city-loc-6)
	(= (ploc package-21) city-loc-9)
	(= (ploc package-22) city-loc-52)
	(= (ploc package-23) city-loc-31)
	(= (ploc package-24) city-loc-32)
	(= (ploc package-25) city-loc-49)
	)
  )
