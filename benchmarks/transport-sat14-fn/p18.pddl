...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p18.pddl
;; 
...
(define (problem p18)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-1-loc-36)
	(= (ploc package-2) city-2-loc-58)
	(= (ploc package-3) city-3-loc-41)
	(= (ploc package-4) city-2-loc-40)
	(= (ploc package-5) city-2-loc-7)
	(= (ploc package-6) city-2-loc-46)
	(= (ploc package-7) city-3-loc-45)
	(= (ploc package-8) city-3-loc-40)
	(= (ploc package-9) city-2-loc-18)
	(= (ploc package-10) city-1-loc-12)
	(= (ploc package-11) city-3-loc-30)
	(= (ploc package-12) city-2-loc-17)
	(= (ploc package-13) city-1-loc-4)
	(= (ploc package-14) city-1-loc-26)
	(= (ploc package-15) city-2-loc-30)
	(= (ploc package-16) city-2-loc-3)
	(= (ploc package-17) city-2-loc-40)
	(= (ploc package-18) city-2-loc-15)
	(= (ploc package-19) city-3-loc-4)
	(= (ploc package-20) city-2-loc-2)
	(= (ploc package-21) city-2-loc-30)
	(= (ploc package-22) city-3-loc-41)
	(= (ploc package-23) city-3-loc-39)
	(= (ploc package-24) city-3-loc-29)
	(= (ploc package-25) city-1-loc-4)
	(= (ploc package-26) city-1-loc-63)
	(= (ploc package-27) city-1-loc-38)
	(= (ploc package-28) city-1-loc-50)
	(= (ploc package-29) city-1-loc-35)
	(= (ploc package-30) city-3-loc-33)
	)
  )
