...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p10.pddl
;; 
...
(define (problem p10)
  ...
  (:init
	...
	(= (ploc package-11) city-2-loc-15)
	(road city-1-loc-42 city-1-loc-1)
	(= (ploc package-20) city-1-loc-53)
	(road city-1-loc-17 city-1-loc-34)
	(= (ploc package-4) city-1-loc-26)
	...
	(= (ploc package-14) city-2-loc-52)
	(= (ploc package-18) city-1-loc-10)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-2-loc-17)
	(= (ploc package-2) city-2-loc-62)
	(= (ploc package-3) city-3-loc-43)
	(= (ploc package-4) city-3-loc-14)
	(= (ploc package-5) city-2-loc-56)
	(= (ploc package-6) city-2-loc-22)
	(= (ploc package-7) city-1-loc-2)
	(= (ploc package-8) city-1-loc-19)
	(= (ploc package-9) city-2-loc-22)
	(= (ploc package-10) city-2-loc-56)
	(= (ploc package-11) city-1-loc-62)
	(= (ploc package-12) city-2-loc-24)
	(= (ploc package-13) city-2-loc-4)
	(= (ploc package-14) city-1-loc-10)
	(= (ploc package-15) city-3-loc-53)
	(= (ploc package-16) city-1-loc-60)
	(= (ploc package-17) city-2-loc-30)
	(= (ploc package-18) city-3-loc-61)
	(= (ploc package-19) city-2-loc-12)
	(= (ploc package-20) city-2-loc-9)
	(= (ploc package-21) city-1-loc-28)
	(= (ploc package-22) city-3-loc-64)
	(= (ploc package-23) city-1-loc-2)
	(= (ploc package-24) city-1-loc-34)
	(= (ploc package-25) city-3-loc-22)
	)
  )
