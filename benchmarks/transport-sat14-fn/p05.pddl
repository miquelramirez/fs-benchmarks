...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p05.pddl
;; 
...
(define (problem p05)
  ...
  (:objects
	...
	city-1-loc-1 city-2-loc-1 city-1-loc-2 city-2-loc-2 city-1-loc-3 city-2-loc-3 city-1-loc-4 city-2-loc-4 city-1-loc-5 city-2-loc-5 city-1-loc-6 city-2-loc-6 city-1-loc-7 city-2-loc-7 city-1-loc-8 city-2-loc-8 city-1-loc-9 city-2-loc-9 city-1-loc-10 city-2-loc-10 city-1-loc-11 city-2-loc-11 city-1-loc-12 city-2-loc-12 city-1-loc-13 city-2-loc-13 city-1-loc-14 city-2-loc-14 city-1-loc-15 city-2-loc-15 city-1-loc-16 city-2-loc-16 city-1-loc-17 city-2-loc-17 city-1-loc-18 city-2-loc-18 city-1-loc-19 city-2-loc-19 city-1-loc-20 city-2-loc-20 city-1-loc-21 city-2-loc-21 city-1-loc-22 city-2-loc-22 city-1-loc-23 city-2-loc-23 city-1-loc-24 city-2-loc-24 city-1-loc-25 city-2-loc-25 city-1-loc-26 city-2-loc-26 city-1-loc-27 city-2-loc-27 city-1-loc-28 city-2-loc-28 city-1-loc-29 city-2-loc-29 city-1-loc-30 city-2-loc-30 city-1-loc-31 city-2-loc-31 city-1-loc-32 city-2-loc-32 city-1-loc-33 city-2-loc-33 city-1-loc-34 city-2-loc-34 city-1-loc-35 city-2-loc-35 city-1-loc-36 city-2-loc-36 city-1-loc-37 city-2-loc-37 city-1-loc-38 city-2-loc-38 city-1-loc-39 city-2-loc-39 city-1-loc-40 city-2-loc-40 city-1-loc-41 city-2-loc-41 city-1-loc-42 city-2-loc-42 city-1-loc-43 city-2-loc-43 city-1-loc-44 city-2-loc-44 city-1-loc-45 city-2-loc-45 city-1-loc-46 city-2-loc-46 city-1-loc-47 city-2-loc-47 city-1-loc-48 city-2-loc-48 city-1-loc-49 city-2-loc-49 city-1-loc-50 city-2-loc-50 city-1-loc-51 city-2-loc-51 city-1-loc-52 city-2-loc-52 city-1-loc-53 city-2-loc-53 city-1-loc-54 city-2-loc-54 city-1-loc-55 city-2-loc-55 city-1-loc-56 city-2-loc-56 city-1-loc-57 city-2-loc-57 city-1-loc-58 city-2-loc-58 city-1-loc-59 city-2-loc-59 city-1-loc-60 city-2-loc-60 city-1-loc-61 city-2-loc-61 city-1-loc-62 city-2-loc-62 city-1-loc-63 city-2-loc-63 city-1-loc-64 city-2-loc-64 city-1-loc-65 city-2-loc-65 city-1-loc-66 city-2-loc-66 city-1-loc-67 city-2-loc-67 - location
  ...
  (:init
	...
	(= (ploc package-22) city-1-loc-30)
	(= (ploc package-25) city-1-loc-33)
	...
	(= (ploc package-17) city-1-loc-39)
	(= (ploc package-18) city-1-loc-48)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-2-loc-14)
	(= (ploc package-2) city-2-loc-66)
	(= (ploc package-3) city-2-loc-52)
	(= (ploc package-4) city-2-loc-9)
	(= (ploc package-5) city-2-loc-62)
	(= (ploc package-6) city-2-loc-31)
	(= (ploc package-7) city-2-loc-9)
	(= (ploc package-8) city-2-loc-35)
	(= (ploc package-9) city-2-loc-38)
	(= (ploc package-10) city-2-loc-39)
	(= (ploc package-11) city-2-loc-9)
	(= (ploc package-12) city-2-loc-65)
	(= (ploc package-13) city-2-loc-49)
	(= (ploc package-14) city-2-loc-29)
	(= (ploc package-15) city-2-loc-29)
	(= (ploc package-16) city-2-loc-66)
	(= (ploc package-17) city-2-loc-46)
	(= (ploc package-18) city-2-loc-36)
	(= (ploc package-19) city-2-loc-19)
	(= (ploc package-20) city-2-loc-26)
	(= (ploc package-21) city-2-loc-10)
	(= (ploc package-22) city-2-loc-21)
	(= (ploc package-23) city-2-loc-9)
	(= (ploc package-24) city-2-loc-13)
	(= (ploc package-25) city-2-loc-42)
	(= (ploc package-26) city-2-loc-52)
	(= (ploc package-27) city-2-loc-52)
	(= (ploc package-28) city-2-loc-21)
	(= (ploc package-29) city-2-loc-2)
	(= (ploc package-30) city-2-loc-45)
	)
  )
