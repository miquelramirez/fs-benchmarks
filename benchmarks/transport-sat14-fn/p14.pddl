...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p14.pddl
;; 
...
(define (problem p14)
  ...
  (:init
	...
	(= (ploc package-17) city-1-loc-42)
	(= (ploc package-22) city-1-loc-20)
	(= (ploc package-23) city-1-loc-21)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-2-loc-38)
	(= (ploc package-2) city-2-loc-19)
	(= (ploc package-3) city-2-loc-40)
	(= (ploc package-4) city-2-loc-17)
	(= (ploc package-5) city-2-loc-49)
	(= (ploc package-6) city-2-loc-29)
	(= (ploc package-7) city-2-loc-32)
	(= (ploc package-8) city-2-loc-42)
	(= (ploc package-9) city-2-loc-1)
	(= (ploc package-10) city-2-loc-7)
	(= (ploc package-11) city-2-loc-14)
	(= (ploc package-12) city-2-loc-29)
	(= (ploc package-13) city-2-loc-13)
	(= (ploc package-14) city-2-loc-27)
	(= (ploc package-15) city-2-loc-53)
	(= (ploc package-16) city-2-loc-33)
	(= (ploc package-17) city-2-loc-10)
	(= (ploc package-18) city-2-loc-1)
	(= (ploc package-19) city-2-loc-17)
	(= (ploc package-20) city-2-loc-16)
	(= (ploc package-21) city-2-loc-47)
	(= (ploc package-22) city-2-loc-14)
	(= (ploc package-23) city-2-loc-1)
	(= (ploc package-24) city-2-loc-31)
	(= (ploc package-25) city-2-loc-56)
	)
  )
