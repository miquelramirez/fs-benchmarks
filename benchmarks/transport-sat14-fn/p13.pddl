...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p13.pddl
;; 
...
(define (problem p13)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-loc-36)
	(= (ploc package-2) city-loc-57)
	(= (ploc package-3) city-loc-40)
	(= (ploc package-4) city-loc-24)
	(= (ploc package-5) city-loc-8)
	(= (ploc package-6) city-loc-50)
	(= (ploc package-7) city-loc-22)
	(= (ploc package-8) city-loc-28)
	(= (ploc package-9) city-loc-9)
	(= (ploc package-10) city-loc-19)
	(= (ploc package-11) city-loc-1)
	(= (ploc package-12) city-loc-43)
	(= (ploc package-13) city-loc-39)
	(= (ploc package-14) city-loc-29)
	(= (ploc package-15) city-loc-29)
	(= (ploc package-16) city-loc-21)
	(= (ploc package-17) city-loc-4)
	(= (ploc package-18) city-loc-11)
	(= (ploc package-19) city-loc-17)
	(= (ploc package-20) city-loc-4)
	(= (ploc package-21) city-loc-17)
	(= (ploc package-22) city-loc-37)
	(= (ploc package-23) city-loc-8)
	(= (ploc package-24) city-loc-9)
	(= (ploc package-25) city-loc-19)
	)
  )
