...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p17.pddl
;; 
...
(define (problem p17)
  ...
  (:init
	...
	(= (ploc package-14) city-2-loc-35)
	(road city-2-loc-25 city-2-loc-52)
	(= (ploc package-24) city-1-loc-51)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-2-loc-4)
	(= (ploc package-2) city-1-loc-36)
	(= (ploc package-3) city-2-loc-51)
	(= (ploc package-4) city-1-loc-7)
	(= (ploc package-5) city-3-loc-20)
	(= (ploc package-6) city-1-loc-35)
	(= (ploc package-7) city-1-loc-56)
	(= (ploc package-8) city-2-loc-15)
	(= (ploc package-9) city-1-loc-33)
	(= (ploc package-10) city-3-loc-52)
	(= (ploc package-11) city-1-loc-13)
	(= (ploc package-12) city-2-loc-12)
	(= (ploc package-13) city-3-loc-37)
	(= (ploc package-14) city-3-loc-7)
	(= (ploc package-15) city-3-loc-57)
	(= (ploc package-16) city-2-loc-58)
	(= (ploc package-17) city-1-loc-7)
	(= (ploc package-18) city-2-loc-60)
	(= (ploc package-19) city-2-loc-23)
	(= (ploc package-20) city-3-loc-43)
	(= (ploc package-21) city-1-loc-46)
	(= (ploc package-22) city-3-loc-42)
	(= (ploc package-23) city-1-loc-3)
	(= (ploc package-24) city-2-loc-20)
	(= (ploc package-25) city-2-loc-39)
	)
  )
