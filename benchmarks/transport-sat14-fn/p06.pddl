...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p06.pddl
;; 
...
(define (problem p06)
  ...
  (:init
	...
	(= (ploc package-21) city-1-loc-27)
	(= (vloc truck-2) city-2-loc-23)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-2-loc-35)
	(= (ploc package-2) city-2-loc-25)
	(= (ploc package-3) city-2-loc-6)
	(= (ploc package-4) city-2-loc-30)
	(= (ploc package-5) city-2-loc-10)
	(= (ploc package-6) city-2-loc-12)
	(= (ploc package-7) city-2-loc-60)
	(= (ploc package-8) city-2-loc-47)
	(= (ploc package-9) city-2-loc-7)
	(= (ploc package-10) city-2-loc-8)
	(= (ploc package-11) city-2-loc-15)
	(= (ploc package-12) city-2-loc-57)
	(= (ploc package-13) city-2-loc-13)
	(= (ploc package-14) city-2-loc-32)
	(= (ploc package-15) city-2-loc-16)
	(= (ploc package-16) city-2-loc-52)
	(= (ploc package-17) city-2-loc-16)
	(= (ploc package-18) city-2-loc-27)
	(= (ploc package-19) city-2-loc-37)
	(= (ploc package-20) city-2-loc-16)
	(= (ploc package-21) city-2-loc-50)
	(= (ploc package-22) city-2-loc-61)
	(= (ploc package-23) city-2-loc-54)
	(= (ploc package-24) city-2-loc-9)
	(= (ploc package-25) city-2-loc-68)
	)
  )
