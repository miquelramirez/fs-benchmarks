...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p20.pddl
;; 
...
(define (problem p20)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-3-loc-61)
	(= (ploc package-2) city-2-loc-65)
	(= (ploc package-3) city-1-loc-42)
	(= (ploc package-4) city-3-loc-25)
	(= (ploc package-5) city-1-loc-14)
	(= (ploc package-6) city-1-loc-13)
	(= (ploc package-7) city-1-loc-23)
	(= (ploc package-8) city-1-loc-36)
	(= (ploc package-9) city-3-loc-8)
	(= (ploc package-10) city-3-loc-35)
	(= (ploc package-11) city-2-loc-42)
	(= (ploc package-12) city-1-loc-9)
	(= (ploc package-13) city-1-loc-47)
	(= (ploc package-14) city-3-loc-3)
	(= (ploc package-15) city-3-loc-41)
	(= (ploc package-16) city-2-loc-64)
	(= (ploc package-17) city-3-loc-25)
	(= (ploc package-18) city-1-loc-25)
	(= (ploc package-19) city-1-loc-7)
	(= (ploc package-20) city-2-loc-55)
	(= (ploc package-21) city-3-loc-18)
	(= (ploc package-22) city-1-loc-6)
	(= (ploc package-23) city-2-loc-56)
	(= (ploc package-24) city-1-loc-20)
	(= (ploc package-25) city-2-loc-37)
	)
  )
