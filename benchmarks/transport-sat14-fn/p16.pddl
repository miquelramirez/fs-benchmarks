...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p16.pddl
;; 
...
(define (problem p16)
  ...
  (:goal
    (and 
	(= (ploc package-1) city-2-loc-6)
	(= (ploc package-2) city-2-loc-44)
	(= (ploc package-3) city-2-loc-57)
	(= (ploc package-4) city-2-loc-19)
	(= (ploc package-5) city-2-loc-26)
	(= (ploc package-6) city-2-loc-55)
	(= (ploc package-7) city-2-loc-1)
	(= (ploc package-8) city-2-loc-39)
	(= (ploc package-9) city-2-loc-5)
	(= (ploc package-10) city-2-loc-13)
	(= (ploc package-11) city-2-loc-19)
	(= (ploc package-12) city-2-loc-53)
	(= (ploc package-13) city-2-loc-22)
	(= (ploc package-14) city-2-loc-57)
	(= (ploc package-15) city-2-loc-46)
	(= (ploc package-16) city-2-loc-33)
	(= (ploc package-17) city-2-loc-26)
	(= (ploc package-18) city-2-loc-19)
	(= (ploc package-19) city-2-loc-21)
	(= (ploc package-20) city-2-loc-16)
	(= (ploc package-21) city-2-loc-4)
	(= (ploc package-22) city-2-loc-15)
	(= (ploc package-23) city-2-loc-35)
	(= (ploc package-24) city-2-loc-17)
	(= (ploc package-25) city-2-loc-2)
	)
  )
