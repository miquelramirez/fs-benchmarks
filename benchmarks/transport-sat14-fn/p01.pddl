...
;; 		/home/gfrances/projects/code/fs-benchmarks/benchmarks/transport-sat14-strips/p01.pddl
;; 
...
(define (problem p01)
  ...
  (:init
	...
	(= (ploc package-8) city-loc-3)
	(= (ploc package-22) city-loc-14)
	...
	(= (ploc package-3) city-loc-16)
	(= (vloc truck-1) city-loc-32)
	(= (vloc truck-3) city-loc-27)
	(road city-loc-46 city-loc-19)
	(road city-loc-43 city-loc-17)
	(= (ploc package-21) city-loc-11)
	(road city-loc-45 city-loc-38)
	(= (ploc package-25) city-loc-24)
	...
	(= (ploc package-10) city-loc-18)
	(road city-loc-36 city-loc-17)
	(road city-loc-9 city-loc-8)
	(road city-loc-31 city-loc-11)
	(road city-loc-6 city-loc-29)
	(road city-loc-3 city-loc-39)
	(= (vloc truck-4) city-loc-45)
	(road city-loc-1 city-loc-24)
	(road city-loc-26 city-loc-41)
	(road city-loc-24 city-loc-50)
	(road city-loc-7 city-loc-49)
	(= (ploc package-15) city-loc-11)
  )

  (:goal
    (and 
	(= (ploc package-1) city-loc-2)
	(= (ploc package-2) city-loc-18)
	(= (ploc package-3) city-loc-3)
	(= (ploc package-4) city-loc-27)
	(= (ploc package-5) city-loc-13)
	(= (ploc package-6) city-loc-39)
	(= (ploc package-7) city-loc-40)
	(= (ploc package-8) city-loc-6)
	(= (ploc package-9) city-loc-37)
	(= (ploc package-10) city-loc-13)
	(= (ploc package-11) city-loc-14)
	(= (ploc package-12) city-loc-16)
	(= (ploc package-13) city-loc-42)
	(= (ploc package-14) city-loc-34)
	(= (ploc package-15) city-loc-15)
	(= (ploc package-16) city-loc-43)
	(= (ploc package-17) city-loc-34)
	(= (ploc package-18) city-loc-32)
	(= (ploc package-19) city-loc-3)
	(= (ploc package-20) city-loc-44)
	(= (ploc package-21) city-loc-37)
	(= (ploc package-22) city-loc-41)
	(= (ploc package-23) city-loc-17)
	(= (ploc package-24) city-loc-23)
	(= (ploc package-25) city-loc-3)
	)
  )
