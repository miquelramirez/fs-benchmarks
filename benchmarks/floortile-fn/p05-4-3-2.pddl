...
;; 		/home/frances/projects/code/fs-benchmarks/benchmarks/floortile-sat14-strips/p05-4-3-2.pddl
;; 

(define (problem p05-4-3-2)
  (:domain floortile-fn)
  (:objects
  ...
  (:init
	...
	(= (painted tile_4-1) somerobot)
	(= (painted tile_4-2) somerobot)
