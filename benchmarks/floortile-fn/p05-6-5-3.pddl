...
;; 		/home/frances/projects/code/fs-benchmarks/benchmarks/floortile-sat14-strips/p05-6-5-3.pddl
;; 

(define (problem p05-6-5-3)
  (:domain floortile-fn)
  (:objects
