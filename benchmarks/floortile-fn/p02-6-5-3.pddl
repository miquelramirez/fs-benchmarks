...
;; 		/home/frances/projects/code/fs-benchmarks/benchmarks/floortile-sat14-strips/p02-6-5-3.pddl
;; 

(define (problem p02-6-5-3)
  (:domain floortile-fn)
  (:objects
