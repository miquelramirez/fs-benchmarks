...
;; 		/home/frances/projects/code/fs-benchmarks/benchmarks/floortile-sat14-strips/p03-6-5-2.pddl
;; 

(define (problem p03-6-5-2)
  (:domain floortile-fn)
  (:objects
