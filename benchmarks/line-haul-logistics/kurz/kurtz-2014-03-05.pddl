(define (problem kurtz-2014-03-05)
...
(= (demand GLADSTONE_VALLEY ambient) 89)
(= (outstanding GLADSTONE_VALLEY ambient) 89)
...
(= (demand BLACKWATER ambient) 4)
(= (outstanding BLACKWATER ambient) 4)
