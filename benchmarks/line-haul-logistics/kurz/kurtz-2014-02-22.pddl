(define (problem kurtz-2014-02-22)
	...
	(:objects
		...
		EMERALD GLADSTONE_VALLEY BILOELA NORTH_ROCKHAMPTON BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_GLADSTONE_VALLEY loc_BILOELA loc_NORTH_ROCKHAMPTON loc_BLACKWATER - location
	)
...
(= (demand GLADSTONE_VALLEY frozen) 38)
(= (outstanding GLADSTONE_VALLEY frozen) 38)
...
(= (demand NORTH_ROCKHAMPTON ambient) 232)
(= (outstanding NORTH_ROCKHAMPTON ambient) 232)
(= (delivered NORTH_ROCKHAMPTON ambient) 0)
(= (demand NORTH_ROCKHAMPTON frozen) 51)
(= (outstanding NORTH_ROCKHAMPTON frozen) 51)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_BLACKWATER) 844)
...
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297)
...
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297) (= (dist loc_BLACKWATER loc_BILOELA) 240) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205)
	)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient))
	...
	(:bounds
		...
		(demand - int[0..232]) ;; between 0 and largest demand of any commodity
