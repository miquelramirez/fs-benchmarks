(define (problem kurtz-2014-02-14)
	...
	(:objects
		...
		EMERALD GLADSTONE_VALLEY BILOELA BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_GLADSTONE_VALLEY loc_BILOELA loc_BLACKWATER - location
	)
...
(= (demand EMERALD frozen) 50)
(= (outstanding EMERALD frozen) 50)
...
(= (demand GLADSTONE_VALLEY frozen) 100)
(= (outstanding GLADSTONE_VALLEY frozen) 100)
...
(= (demand BILOELA frozen) 23)
(= (outstanding BILOELA frozen) 23)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_BLACKWATER) 844)
...
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_BLACKWATER) 240)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297) (= (dist loc_BLACKWATER loc_BILOELA) 240)
	)
