(define (problem kurtz-2014-08-16)
	...
	(:objects
		...
		EMERALD GLADSTONE_VALLEY BILOELA NORTH_ROCKHAMPTON - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_GLADSTONE_VALLEY loc_BILOELA loc_NORTH_ROCKHAMPTON - location
	)
...
(= (delivered NORTH_ROCKHAMPTON frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676)
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_BILOELA) 315) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118)
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153)
