(define (problem kurtz-2013-11-09)
	...
	(:objects
		...
		GLADSTONE_VALLEY BILOELA NORTH_ROCKHAMPTON EMERALD BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_GLADSTONE_VALLEY loc_BILOELA loc_NORTH_ROCKHAMPTON loc_EMERALD loc_BLACKWATER - location
	)
...
(= (demand NORTH_ROCKHAMPTON ambient) 78)
(= (outstanding NORTH_ROCKHAMPTON ambient) 78)
...
(= (demand EMERALD ambient) 30)
(= (outstanding EMERALD ambient) 30)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BLACKWATER) 844)
...
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_BLACKWATER) 205)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient))
	...
	(:bounds
		...
		(demand - int[0..78]) ;; between 0 and largest demand of any commodity
