(define (problem kurtz-2014-07-19)
	...
	(:objects
		...
		EMERALD GLADSTONE_VALLEY BLACKWATER NORTH_ROCKHAMPTON BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_GLADSTONE_VALLEY loc_BLACKWATER loc_NORTH_ROCKHAMPTON loc_BILOELA - location
	)
...
(= (demand EMERALD ambient) 36)
(= (outstanding EMERALD ambient) 36)
...
(= (demand GLADSTONE_VALLEY ambient) 71)
(= (outstanding GLADSTONE_VALLEY ambient) 71)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 34)
(= (outstanding GLADSTONE_VALLEY frozen) 34)
...
(= (demand NORTH_ROCKHAMPTON ambient) 72)
(= (outstanding NORTH_ROCKHAMPTON ambient) 72)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_BILOELA) 605)
...
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205) (= (dist loc_BLACKWATER loc_BILOELA) 240)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient))
	...
	(:bounds
		...
		(demand - int[0..72]) ;; between 0 and largest demand of any commodity
