(define (problem kurtz-2013-11-15)
...
(= (demand BILOELA ambient) 24)
(= (outstanding BILOELA ambient) 24)
(= (delivered BILOELA ambient) 0)
(= (demand BILOELA frozen) 15)
(= (outstanding BILOELA frozen) 15)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..100]) ;; between 0 and largest demand of any commodity
