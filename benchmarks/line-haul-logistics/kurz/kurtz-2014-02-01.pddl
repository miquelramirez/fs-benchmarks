(define (problem kurtz-2014-02-01)
	...
	(:objects
		...
		NORTH_ROCKHAMPTON GLADSTONE_VALLEY EMERALD BILOELA BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY loc_EMERALD loc_BILOELA loc_BLACKWATER - location
	)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_BLACKWATER) 844)
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153) (= (dist loc_NORTH_ROCKHAMPTON loc_BLACKWATER) 205)
...
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_BLACKWATER) 240)
