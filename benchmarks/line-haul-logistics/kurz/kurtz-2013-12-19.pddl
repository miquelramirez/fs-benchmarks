(define (problem kurtz-2013-12-19)
	...
	(:objects
		...
		EMERALD BLACKWATER BILOELA GLADSTONE_VALLEY - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_BLACKWATER loc_BILOELA loc_GLADSTONE_VALLEY - location
	)
...
(= (demand BLACKWATER ambient) 14)
(= (outstanding BLACKWATER ambient) 14)
...
(= (demand BILOELA ambient) 16)
(= (outstanding BILOELA ambient) 16)
(= (delivered BILOELA ambient) 0)
(= (demand BILOELA frozen) 20)
(= (outstanding BILOELA frozen) 20)
(= (delivered BILOELA frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 112)
(= (outstanding GLADSTONE_VALLEY ambient) 112)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 84)
(= (outstanding GLADSTONE_VALLEY frozen) 84)
(= (delivered GLADSTONE_VALLEY frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565)
...
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137)
	)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..112]) ;; between 0 and largest demand of any commodity
