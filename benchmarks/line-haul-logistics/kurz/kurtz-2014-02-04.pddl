(define (problem kurtz-2014-02-04)
...
(= (demand EMERALD frozen) 31)
(= (outstanding EMERALD frozen) 31)
(= (delivered EMERALD frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 50)
(= (outstanding GLADSTONE_VALLEY ambient) 50)
