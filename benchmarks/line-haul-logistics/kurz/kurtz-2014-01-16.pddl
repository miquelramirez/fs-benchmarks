(define (problem kurtz-2014-01-16)
	...
	(:objects
		...
		BLACKWATER EMERALD GLADSTONE_VALLEY BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_BLACKWATER loc_EMERALD loc_GLADSTONE_VALLEY loc_BILOELA - location
	)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605)
