(define (problem kurtz-2014-07-14)
...
(= (demand GLADSTONE_VALLEY frozen) 56)
(= (outstanding GLADSTONE_VALLEY frozen) 56)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..60]) ;; between 0 and largest demand of any commodity
