(define (problem kurtz-2014-01-17)
...
(= (demand EMERALD frozen) 46)
(= (outstanding EMERALD frozen) 46)
...
(= (demand GLADSTONE_VALLEY ambient) 97)
(= (outstanding GLADSTONE_VALLEY ambient) 97)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..105]) ;; between 0 and largest demand of any commodity
