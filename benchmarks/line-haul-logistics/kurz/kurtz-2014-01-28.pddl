(define (problem kurtz-2014-01-28)
...
(= (demand BILOELA frozen) 10)
(= (outstanding BILOELA frozen) 10)
...
(= (demand BLACKWATER ambient) 13)
(= (outstanding BLACKWATER ambient) 13)
...
(= (demand GLADSTONE_VALLEY frozen) 64)
(= (outstanding GLADSTONE_VALLEY frozen) 64)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..64]) ;; between 0 and largest demand of any commodity
