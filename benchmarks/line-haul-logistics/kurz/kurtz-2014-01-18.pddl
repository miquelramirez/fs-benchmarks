(define (problem kurtz-2014-01-18)
	...
	(:objects
		...
		BILOELA EMERALD NORTH_ROCKHAMPTON GLADSTONE_VALLEY BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_EMERALD loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY loc_BLACKWATER - location
	)
...
(= (demand EMERALD ambient) 27)
(= (outstanding EMERALD ambient) 27)
...
(= (demand NORTH_ROCKHAMPTON ambient) 73)
(= (outstanding NORTH_ROCKHAMPTON ambient) 73)
(= (delivered NORTH_ROCKHAMPTON ambient) 0)
(= (demand NORTH_ROCKHAMPTON frozen) 57)
(= (outstanding NORTH_ROCKHAMPTON frozen) 57)
(= (delivered NORTH_ROCKHAMPTON frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 58)
(= (outstanding GLADSTONE_VALLEY ambient) 58)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 26)
(= (outstanding GLADSTONE_VALLEY frozen) 26)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844)
...
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_BILOELA) 315) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_BLACKWATER) 79)
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118) (= (dist loc_NORTH_ROCKHAMPTON loc_BLACKWATER) 205)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_BILOELA) 240) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297)
	)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient))
	...
	(:bounds
		...
		(demand - int[0..73]) ;; between 0 and largest demand of any commodity
