(define (problem kurtz-2014-06-03)
...
(= (demand EMERALD ambient) 11)
(= (outstanding EMERALD ambient) 11)
(= (delivered EMERALD ambient) 0)
(= (demand EMERALD frozen) 16)
(= (outstanding EMERALD frozen) 16)
(= (delivered EMERALD frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 53)
(= (outstanding GLADSTONE_VALLEY ambient) 53)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient)) (= (delivered BILOELA frozen) (demand BILOELA frozen))
	...
	(:bounds
		...
		(demand - int[0..63]) ;; between 0 and largest demand of any commodity
