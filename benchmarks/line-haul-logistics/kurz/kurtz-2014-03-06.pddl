(define (problem kurtz-2014-03-06)
	...
	(:objects
		...
		BILOELA EMERALD BLACKWATER GLADSTONE_VALLEY - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_EMERALD loc_BLACKWATER loc_GLADSTONE_VALLEY - location
	)
...
(= (demand BILOELA frozen) 17)
(= (outstanding BILOELA frozen) 17)
...
(= (demand BLACKWATER ambient) 25)
(= (outstanding BLACKWATER ambient) 25)
...
(= (demand GLADSTONE_VALLEY ambient) 104)
(= (outstanding GLADSTONE_VALLEY ambient) 104)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 73)
(= (outstanding GLADSTONE_VALLEY frozen) 73)
(= (delivered GLADSTONE_VALLEY frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..104]) ;; between 0 and largest demand of any commodity
