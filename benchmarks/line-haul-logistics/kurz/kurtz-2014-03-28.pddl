(define (problem kurtz-2014-03-28)
...
(= (demand GLADSTONE_VALLEY ambient) 108)
(= (outstanding GLADSTONE_VALLEY ambient) 108)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 99)
(= (outstanding GLADSTONE_VALLEY frozen) 99)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..108]) ;; between 0 and largest demand of any commodity
