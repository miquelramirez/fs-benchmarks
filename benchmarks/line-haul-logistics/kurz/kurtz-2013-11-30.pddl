(define (problem kurtz-2013-11-30)
	...
	(:objects
		...
		NORTH_ROCKHAMPTON BLACKWATER BILOELA EMERALD GLADSTONE_VALLEY - customer
		ambient frozen - commodity
		loc_BRDC loc_NORTH_ROCKHAMPTON loc_BLACKWATER loc_BILOELA loc_EMERALD loc_GLADSTONE_VALLEY - location
	)
...
(= (demand NORTH_ROCKHAMPTON frozen) 59)
(= (outstanding NORTH_ROCKHAMPTON frozen) 59)
...
(= (demand EMERALD frozen) 8)
(= (outstanding EMERALD frozen) 8)
(= (delivered EMERALD frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 63)
(= (outstanding GLADSTONE_VALLEY ambient) 63)
...
(= (delivered GLADSTONE_VALLEY frozen) 0)
		...
		(= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565)
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_BLACKWATER) 205) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205) (= (dist loc_BLACKWATER loc_BILOELA) 240) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297)
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153) (= (dist loc_BILOELA loc_BLACKWATER) 240) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137)
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281) (= (dist loc_EMERALD loc_BLACKWATER) 79) (= (dist loc_EMERALD loc_BILOELA) 315) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372)
	)
