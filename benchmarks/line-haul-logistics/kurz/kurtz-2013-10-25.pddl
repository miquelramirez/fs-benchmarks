(define (problem kurtz-2013-10-25)
	...
	(:objects
		...
		BILOELA EMERALD GLADSTONE_VALLEY BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_EMERALD loc_GLADSTONE_VALLEY loc_BLACKWATER - location
	)
...
(= (demand BILOELA frozen) 14)
(= (outstanding BILOELA frozen) 14)
...
(= (demand EMERALD frozen) 48)
(= (outstanding EMERALD frozen) 48)
...
(= (demand BLACKWATER ambient) 18)
(= (outstanding BLACKWATER ambient) 18)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844)
...
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_BILOELA) 315) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_BLACKWATER) 79)
