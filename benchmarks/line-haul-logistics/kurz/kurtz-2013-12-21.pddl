(define (problem kurtz-2013-12-21)
	...
	(:objects
		...
		EMERALD BILOELA GLADSTONE_VALLEY BLACKWATER NORTH_ROCKHAMPTON - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_BILOELA loc_GLADSTONE_VALLEY loc_BLACKWATER loc_NORTH_ROCKHAMPTON - location
	)
...
(= (demand EMERALD ambient) 52)
(= (outstanding EMERALD ambient) 52)
(= (delivered EMERALD ambient) 0)
(= (demand EMERALD frozen) 6)
(= (outstanding EMERALD frozen) 6)
...
(= (demand GLADSTONE_VALLEY ambient) 119)
(= (outstanding GLADSTONE_VALLEY ambient) 119)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 53)
(= (outstanding GLADSTONE_VALLEY frozen) 53)
(= (delivered GLADSTONE_VALLEY frozen) 0)
(= (site BLACKWATER) loc_BLACKWATER)
(= (demand BLACKWATER ambient) 12)
(= (outstanding BLACKWATER ambient) 12)
...
(= (demand NORTH_ROCKHAMPTON ambient) 280)
(= (outstanding NORTH_ROCKHAMPTON ambient) 280)
(= (delivered NORTH_ROCKHAMPTON ambient) 0)
(= (demand NORTH_ROCKHAMPTON frozen) 115)
(= (outstanding NORTH_ROCKHAMPTON frozen) 115)
(= (delivered NORTH_ROCKHAMPTON frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676)
...
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_BLACKWATER) 240) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153)
...
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_BILOELA) 240) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205)
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118) (= (dist loc_NORTH_ROCKHAMPTON loc_BLACKWATER) 205)
	)
...
(= (delivered NORTH_ROCKHAMPTON ambient) (demand NORTH_ROCKHAMPTON ambient)) (= (delivered NORTH_ROCKHAMPTON frozen) (demand NORTH_ROCKHAMPTON frozen))
	...
	(:bounds
		...
		(demand - int[0..280]) ;; between 0 and largest demand of any commodity
