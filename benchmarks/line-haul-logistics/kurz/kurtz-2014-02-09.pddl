(define (problem kurtz-2014-02-09)
...
(= (demand GLADSTONE_VALLEY ambient) 2)
(= (outstanding GLADSTONE_VALLEY ambient) 2)
...
(= (demand BILOELA ambient) 0)
(= (outstanding BILOELA ambient) 0)
(= (delivered BILOELA ambient) 0)
(= (demand BILOELA frozen) 40)
(= (outstanding BILOELA frozen) 40)
...
(= (delivered BILOELA frozen) (demand BILOELA frozen))
