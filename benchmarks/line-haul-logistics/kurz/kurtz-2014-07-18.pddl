(define (problem kurtz-2014-07-18)
...
(= (demand GLADSTONE_VALLEY ambient) 98)
(= (outstanding GLADSTONE_VALLEY ambient) 98)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 90)
(= (outstanding GLADSTONE_VALLEY frozen) 90)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..98]) ;; between 0 and largest demand of any commodity
