(define (problem kurtz-2014-05-01)
...
(= (demand BILOELA ambient) 10)
(= (outstanding BILOELA ambient) 10)
...
(= (demand BLACKWATER ambient) 20)
(= (outstanding BLACKWATER ambient) 20)
...
(= (delivered EMERALD ambient) (demand EMERALD ambient)) (= (delivered EMERALD frozen) (demand EMERALD frozen))
	...
	(:bounds
		...
		(demand - int[0..80]) ;; between 0 and largest demand of any commodity
