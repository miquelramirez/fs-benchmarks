(define (problem kurtz-2014-07-02)
...
(= (demand GLADSTONE_VALLEY ambient) 94)
(= (outstanding GLADSTONE_VALLEY ambient) 94)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..94]) ;; between 0 and largest demand of any commodity
