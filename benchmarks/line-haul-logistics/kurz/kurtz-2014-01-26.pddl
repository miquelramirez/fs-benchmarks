(define (problem kurtz-2014-01-26)
...
(= (demand GLADSTONE_VALLEY ambient) 4)
(= (outstanding GLADSTONE_VALLEY ambient) 4)
...
(= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..59]) ;; between 0 and largest demand of any commodity
