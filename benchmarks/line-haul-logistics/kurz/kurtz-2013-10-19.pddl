(define (problem kurtz-2013-10-19)
	...
	(:objects
		...
		BILOELA GLADSTONE_VALLEY NORTH_ROCKHAMPTON EMERALD BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON loc_EMERALD loc_BLACKWATER - location
	)
...
(= (demand GLADSTONE_VALLEY ambient) 73)
(= (outstanding GLADSTONE_VALLEY ambient) 73)
...
(= (demand NORTH_ROCKHAMPTON ambient) 88)
(= (outstanding NORTH_ROCKHAMPTON ambient) 88)
...
(= (demand EMERALD frozen) 2)
(= (outstanding EMERALD frozen) 2)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BLACKWATER) 844)
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_BLACKWATER) 240)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297)
...
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_BILOELA) 315) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281) (= (dist loc_EMERALD loc_BLACKWATER) 79)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_BILOELA) 240) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205) (= (dist loc_BLACKWATER loc_EMERALD) 79)
	)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..88]) ;; between 0 and largest demand of any commodity
