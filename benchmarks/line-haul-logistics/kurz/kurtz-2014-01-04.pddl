(define (problem kurtz-2014-01-04)
	...
	(:objects
		...
		NORTH_ROCKHAMPTON EMERALD BILOELA BLACKWATER GLADSTONE_VALLEY - customer
		ambient frozen - commodity
		loc_BRDC loc_NORTH_ROCKHAMPTON loc_EMERALD loc_BILOELA loc_BLACKWATER loc_GLADSTONE_VALLEY - location
	)
...
(= (demand NORTH_ROCKHAMPTON frozen) 47)
(= (outstanding NORTH_ROCKHAMPTON frozen) 47)
(= (delivered NORTH_ROCKHAMPTON frozen) 0)
(= (site EMERALD) loc_EMERALD)
(= (demand EMERALD ambient) 19)
(= (outstanding EMERALD ambient) 19)
...
(= (demand BLACKWATER ambient) 1)
(= (outstanding BLACKWATER ambient) 1)
...
(= (demand GLADSTONE_VALLEY ambient) 54)
(= (outstanding GLADSTONE_VALLEY ambient) 54)
...
(= (delivered GLADSTONE_VALLEY frozen) 0)
		...
		(= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565)
...
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281) (= (dist loc_EMERALD loc_BILOELA) 315) (= (dist loc_EMERALD loc_BLACKWATER) 79) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372)
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_BLACKWATER) 240) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_BILOELA) 240) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297)
