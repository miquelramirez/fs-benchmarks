(define (problem kurtz-2014-06-07)
...
(= (demand GLADSTONE_VALLEY ambient) 62)
(= (outstanding GLADSTONE_VALLEY ambient) 62)
...
(= (demand NORTH_ROCKHAMPTON ambient) 69)
(= (outstanding NORTH_ROCKHAMPTON ambient) 69)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient))
	...
	(:bounds
		...
		(demand - int[0..69]) ;; between 0 and largest demand of any commodity
