(define (problem kurtz-2013-12-13)
	...
	(:objects
		...
		GLADSTONE_VALLEY BILOELA EMERALD BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_GLADSTONE_VALLEY loc_BILOELA loc_EMERALD loc_BLACKWATER - location
	)
...
(= (demand GLADSTONE_VALLEY ambient) 126)
(= (outstanding GLADSTONE_VALLEY ambient) 126)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 108)
(= (outstanding GLADSTONE_VALLEY frozen) 108)
(= (delivered GLADSTONE_VALLEY frozen) 0)
(= (site BILOELA) loc_BILOELA)
(= (demand BILOELA ambient) 31)
(= (outstanding BILOELA ambient) 31)
...
(= (demand EMERALD ambient) 42)
(= (outstanding EMERALD ambient) 42)
(= (delivered EMERALD ambient) 0)
(= (demand EMERALD frozen) 58)
(= (outstanding EMERALD frozen) 58)
(= (delivered EMERALD frozen) 0)
(= (site BLACKWATER) loc_BLACKWATER)
(= (demand BLACKWATER ambient) 22)
(= (outstanding BLACKWATER ambient) 22)
(= (delivered BLACKWATER ambient) 0)
(= (demand BLACKWATER frozen) 14)
(= (outstanding BLACKWATER frozen) 14)
(= (delivered BLACKWATER frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BLACKWATER) 844)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297)
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_BLACKWATER) 240)
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_BILOELA) 315) (= (dist loc_EMERALD loc_BLACKWATER) 79)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..126]) ;; between 0 and largest demand of any commodity
