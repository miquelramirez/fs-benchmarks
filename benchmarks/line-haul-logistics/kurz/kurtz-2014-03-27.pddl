(define (problem kurtz-2014-03-27)
...
(= (demand GLADSTONE_VALLEY frozen) 78)
(= (outstanding GLADSTONE_VALLEY frozen) 78)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..97]) ;; between 0 and largest demand of any commodity
