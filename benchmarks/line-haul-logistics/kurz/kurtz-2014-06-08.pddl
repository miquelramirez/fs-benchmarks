(define (problem kurtz-2014-06-08)
...
(= (demand GLADSTONE_VALLEY ambient) 11)
(= (outstanding GLADSTONE_VALLEY ambient) 11)
...
(= (demand EMERALD ambient) 3)
(= (outstanding EMERALD ambient) 3)
...
(= (delivered EMERALD ambient) (demand EMERALD ambient)) (= (delivered EMERALD frozen) (demand EMERALD frozen))
	...
	(:bounds
		...
		(demand - int[0..55]) ;; between 0 and largest demand of any commodity
