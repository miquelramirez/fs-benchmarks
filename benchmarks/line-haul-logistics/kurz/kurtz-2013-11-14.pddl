(define (problem kurtz-2013-11-14)
...
(= (demand GLADSTONE_VALLEY ambient) 128)
(= (outstanding GLADSTONE_VALLEY ambient) 128)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 81)
(= (outstanding GLADSTONE_VALLEY frozen) 81)
(= (delivered GLADSTONE_VALLEY frozen) 0)
(= (site BILOELA) loc_BILOELA)
(= (demand BILOELA ambient) 18)
(= (outstanding BILOELA ambient) 18)
(= (delivered BILOELA ambient) 0)
(= (demand BILOELA frozen) 19)
(= (outstanding BILOELA frozen) 19)
...
(= (demand EMERALD frozen) 41)
(= (outstanding EMERALD frozen) 41)
...
(= (demand BLACKWATER frozen) 18)
(= (outstanding BLACKWATER frozen) 18)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..128]) ;; between 0 and largest demand of any commodity
