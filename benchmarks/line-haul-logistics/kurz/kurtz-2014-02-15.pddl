(define (problem kurtz-2014-02-15)
	...
	(:objects
		...
		BILOELA EMERALD NORTH_ROCKHAMPTON GLADSTONE_VALLEY - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_EMERALD loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY - location
	)
...
(= (delivered GLADSTONE_VALLEY frozen) 0)
		...
		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565)
...
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118)
	)
