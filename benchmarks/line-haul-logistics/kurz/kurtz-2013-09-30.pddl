(define (problem kurtz-2013-09-30)
...
(= (demand EMERALD ambient) 51)
(= (outstanding EMERALD ambient) 51)
(= (delivered EMERALD ambient) 0)
(= (demand EMERALD frozen) 18)
(= (outstanding EMERALD frozen) 18)
...
(= (demand GLADSTONE_VALLEY frozen) 41)
(= (outstanding GLADSTONE_VALLEY frozen) 41)
...
(= (demand BILOELA ambient) 28)
(= (outstanding BILOELA ambient) 28)
