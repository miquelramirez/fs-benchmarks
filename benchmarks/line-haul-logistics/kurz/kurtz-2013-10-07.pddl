(define (problem kurtz-2013-10-07)
	...
	(:objects
		...
		EMERALD GLADSTONE_VALLEY BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_GLADSTONE_VALLEY loc_BLACKWATER - location
	)
...
(= (demand EMERALD ambient) 2)
(= (outstanding EMERALD ambient) 2)
...
(= (demand GLADSTONE_VALLEY ambient) 18)
(= (outstanding GLADSTONE_VALLEY ambient) 18)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 12)
(= (outstanding GLADSTONE_VALLEY frozen) 12)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844)
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_BLACKWATER) 79)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297)
	)
...
(= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..18]) ;; between 0 and largest demand of any commodity
