(define (problem kurtz-2014-05-17)
	...
	(:objects
		...
		EMERALD NORTH_ROCKHAMPTON BLACKWATER GLADSTONE_VALLEY BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_NORTH_ROCKHAMPTON loc_BLACKWATER loc_GLADSTONE_VALLEY loc_BILOELA - location
	)
...
(= (demand GLADSTONE_VALLEY ambient) 55)
(= (outstanding GLADSTONE_VALLEY ambient) 55)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605)
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281) (= (dist loc_EMERALD loc_BLACKWATER) 79) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_BILOELA) 315)
