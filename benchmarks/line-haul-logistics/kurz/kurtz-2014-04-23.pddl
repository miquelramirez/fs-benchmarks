(define (problem kurtz-2014-04-23)
	...
	(:objects
		...
		BLACKWATER BILOELA EMERALD GLADSTONE_VALLEY - customer
		ambient frozen - commodity
		loc_BRDC loc_BLACKWATER loc_BILOELA loc_EMERALD loc_GLADSTONE_VALLEY - location
	)
...
(= (demand BLACKWATER ambient) 17)
(= (outstanding BLACKWATER ambient) 17)
...
(= (demand BILOELA ambient) 17)
(= (outstanding BILOELA ambient) 17)
(= (delivered BILOELA ambient) 0)
(= (demand BILOELA frozen) 24)
(= (outstanding BILOELA frozen) 24)
...
(= (demand EMERALD frozen) 42)
(= (outstanding EMERALD frozen) 42)
(= (delivered EMERALD frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 111)
(= (outstanding GLADSTONE_VALLEY ambient) 111)
...
(= (delivered GLADSTONE_VALLEY frozen) 0)
		...
		(= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..111]) ;; between 0 and largest demand of any commodity
