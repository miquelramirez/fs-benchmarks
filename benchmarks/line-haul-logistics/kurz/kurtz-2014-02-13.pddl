(define (problem kurtz-2014-02-13)
	...
	(:objects
		...
		BLACKWATER BILOELA GLADSTONE_VALLEY EMERALD - customer
		ambient frozen - commodity
		loc_BRDC loc_BLACKWATER loc_BILOELA loc_GLADSTONE_VALLEY loc_EMERALD - location
	)
...
(= (delivered EMERALD frozen) 0)
		...
		(= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_EMERALD) 869)
...
(= (delivered EMERALD ambient) (demand EMERALD ambient)) (= (delivered EMERALD frozen) (demand EMERALD frozen))
	...
	(:bounds
		...
		(demand - int[0..101]) ;; between 0 and largest demand of any commodity
