(define (problem kurtz-2014-05-08)
...
(= (demand GLADSTONE_VALLEY ambient) 91)
(= (outstanding GLADSTONE_VALLEY ambient) 91)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 95)
(= (outstanding GLADSTONE_VALLEY frozen) 95)
