(define (problem kurtz-2014-07-15)
	...
	(:objects
		...
		EMERALD BILOELA GLADSTONE_VALLEY BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_BILOELA loc_GLADSTONE_VALLEY loc_BLACKWATER - location
	)
...
(= (demand EMERALD ambient) 20)
(= (outstanding EMERALD ambient) 20)
...
(= (demand GLADSTONE_VALLEY frozen) 65)
(= (outstanding GLADSTONE_VALLEY frozen) 65)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..65]) ;; between 0 and largest demand of any commodity
