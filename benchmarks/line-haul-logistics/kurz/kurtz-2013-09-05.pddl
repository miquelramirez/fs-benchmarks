(define (problem kurtz-2013-09-05)
...
(= (demand BILOELA frozen) 33)
(= (outstanding BILOELA frozen) 33)
(= (delivered BILOELA frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 93)
(= (outstanding GLADSTONE_VALLEY ambient) 93)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 83)
(= (outstanding GLADSTONE_VALLEY frozen) 83)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..93]) ;; between 0 and largest demand of any commodity
