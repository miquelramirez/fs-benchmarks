(define (problem kurtz-2013-09-20)
...
(= (demand GLADSTONE_VALLEY ambient) 86)
(= (outstanding GLADSTONE_VALLEY ambient) 86)
...
(= (demand BLACKWATER frozen) 5)
(= (outstanding BLACKWATER frozen) 5)
...
(= (delivered EMERALD ambient) (demand EMERALD ambient)) (= (delivered EMERALD frozen) (demand EMERALD frozen))
	...
	(:bounds
		...
		(demand - int[0..86]) ;; between 0 and largest demand of any commodity
