(define (problem kurtz-2014-02-21)
...
(= (demand GLADSTONE_VALLEY ambient) 117)
(= (outstanding GLADSTONE_VALLEY ambient) 117)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 76)
(= (outstanding GLADSTONE_VALLEY frozen) 76)
...
(= (demand BLACKWATER frozen) 9)
(= (outstanding BLACKWATER frozen) 9)
(= (delivered BLACKWATER frozen) 0)
(= (site BILOELA) loc_BILOELA)
(= (demand BILOELA ambient) 19)
(= (outstanding BILOELA ambient) 19)
...
(= (demand EMERALD ambient) 44)
(= (outstanding EMERALD ambient) 44)
...
(= (delivered EMERALD ambient) (demand EMERALD ambient)) (= (delivered EMERALD frozen) (demand EMERALD frozen))
	...
	(:bounds
		...
		(demand - int[0..117]) ;; between 0 and largest demand of any commodity
