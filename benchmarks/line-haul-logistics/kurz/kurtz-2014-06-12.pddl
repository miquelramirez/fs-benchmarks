(define (problem kurtz-2014-06-12)
...
(= (demand GLADSTONE_VALLEY frozen) 71)
(= (outstanding GLADSTONE_VALLEY frozen) 71)
...
(= (demand BILOELA ambient) 8)
(= (outstanding BILOELA ambient) 8)
