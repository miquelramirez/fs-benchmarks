(define (problem kurtz-2013-11-05)
...
(= (demand EMERALD frozen) 35)
(= (outstanding EMERALD frozen) 35)
...
(= (demand GLADSTONE_VALLEY ambient) 49)
(= (outstanding GLADSTONE_VALLEY ambient) 49)
