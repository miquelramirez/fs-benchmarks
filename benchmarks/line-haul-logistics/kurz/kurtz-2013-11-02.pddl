(define (problem kurtz-2013-11-02)
	...
	(:objects
		...
		EMERALD NORTH_ROCKHAMPTON BLACKWATER BILOELA GLADSTONE_VALLEY - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_NORTH_ROCKHAMPTON loc_BLACKWATER loc_BILOELA loc_GLADSTONE_VALLEY - location
	)
...
(= (demand EMERALD ambient) 34)
(= (outstanding EMERALD ambient) 34)
...
(= (demand NORTH_ROCKHAMPTON ambient) 74)
(= (outstanding NORTH_ROCKHAMPTON ambient) 74)
(= (delivered NORTH_ROCKHAMPTON ambient) 0)
(= (demand NORTH_ROCKHAMPTON frozen) 58)
(= (outstanding NORTH_ROCKHAMPTON frozen) 58)
...
(= (demand GLADSTONE_VALLEY ambient) 75)
(= (outstanding GLADSTONE_VALLEY ambient) 75)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 33)
(= (outstanding GLADSTONE_VALLEY frozen) 33)
(= (delivered GLADSTONE_VALLEY frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565)
...
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_BLACKWATER) 205) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205) (= (dist loc_BLACKWATER loc_BILOELA) 240) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297)
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153) (= (dist loc_BILOELA loc_BLACKWATER) 240) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137)
	)
