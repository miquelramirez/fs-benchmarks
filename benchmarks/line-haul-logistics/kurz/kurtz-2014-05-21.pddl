(define (problem kurtz-2014-05-21)
...
(= (demand GLADSTONE_VALLEY ambient) 78)
(= (outstanding GLADSTONE_VALLEY ambient) 78)
...
(= (demand BLACKWATER ambient) 5)
(= (outstanding BLACKWATER ambient) 5)
