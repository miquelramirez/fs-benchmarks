(define (problem kurtz-2013-10-11)
	...
	(:objects
		...
		EMERALD BILOELA BLACKWATER GLADSTONE_VALLEY - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_BILOELA loc_BLACKWATER loc_GLADSTONE_VALLEY - location
	)
...
(= (demand EMERALD ambient) 38)
(= (outstanding EMERALD ambient) 38)
(= (delivered EMERALD ambient) 0)
(= (demand EMERALD frozen) 52)
(= (outstanding EMERALD frozen) 52)
(= (delivered EMERALD frozen) 0)
(= (site BILOELA) loc_BILOELA)
(= (demand BILOELA ambient) 20)
(= (outstanding BILOELA ambient) 20)
(= (delivered BILOELA ambient) 0)
(= (demand BILOELA frozen) 21)
(= (outstanding BILOELA frozen) 21)
(= (delivered BILOELA frozen) 0)
(= (site BLACKWATER) loc_BLACKWATER)
(= (demand BLACKWATER ambient) 24)
(= (outstanding BLACKWATER ambient) 24)
(= (delivered BLACKWATER ambient) 0)
(= (demand BLACKWATER frozen) 12)
(= (outstanding BLACKWATER frozen) 12)
(= (delivered BLACKWATER frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 107)
(= (outstanding GLADSTONE_VALLEY ambient) 107)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 109)
(= (outstanding GLADSTONE_VALLEY frozen) 109)
(= (delivered GLADSTONE_VALLEY frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565)
...
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_BLACKWATER) 240) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137)
...
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297)
	)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..109]) ;; between 0 and largest demand of any commodity
