(define (problem kurtz-2014-04-19)
	...
	(:objects
		...
		NORTH_ROCKHAMPTON GLADSTONE_VALLEY EMERALD BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY loc_EMERALD loc_BILOELA - location
	)
...
(= (demand NORTH_ROCKHAMPTON ambient) 135)
(= (outstanding NORTH_ROCKHAMPTON ambient) 135)
...
(= (demand GLADSTONE_VALLEY frozen) 21)
(= (outstanding GLADSTONE_VALLEY frozen) 21)
...
(= (demand EMERALD frozen) 13)
(= (outstanding EMERALD frozen) 13)
...
(= (demand BILOELA frozen) 8)
(= (outstanding BILOELA frozen) 8)
(= (delivered BILOELA frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605)
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137)
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_BILOELA) 315)
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_EMERALD) 315)
	)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient)) (= (delivered BILOELA frozen) (demand BILOELA frozen))
	...
	(:bounds
		...
		(demand - int[0..135]) ;; between 0 and largest demand of any commodity
