(define (problem kurtz-2013-12-31)
...
(= (demand GLADSTONE_VALLEY ambient) 46)
(= (outstanding GLADSTONE_VALLEY ambient) 46)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 20)
(= (outstanding GLADSTONE_VALLEY frozen) 20)
(= (delivered GLADSTONE_VALLEY frozen) 0)
(= (site EMERALD) loc_EMERALD)
(= (demand EMERALD ambient) 14)
(= (outstanding EMERALD ambient) 14)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..46]) ;; between 0 and largest demand of any commodity
