(define (problem kurtz-2014-05-31)
	...
	(:objects
		...
		NORTH_ROCKHAMPTON EMERALD GLADSTONE_VALLEY BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_NORTH_ROCKHAMPTON loc_EMERALD loc_GLADSTONE_VALLEY loc_BILOELA - location
	)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605)
