(define (problem kurtz-2013-12-14)
	...
	(:objects
		...
		GLADSTONE_VALLEY NORTH_ROCKHAMPTON BILOELA EMERALD BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON loc_BILOELA loc_EMERALD loc_BLACKWATER - location
	)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BLACKWATER) 844)
