(define (problem kurtz-2014-08-02)
	...
	(:objects
		...
		BLACKWATER EMERALD BILOELA GLADSTONE_VALLEY NORTH_ROCKHAMPTON - customer
		ambient frozen - commodity
		loc_BRDC loc_BLACKWATER loc_EMERALD loc_BILOELA loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON - location
	)
...
(= (demand NORTH_ROCKHAMPTON frozen) 40)
(= (outstanding NORTH_ROCKHAMPTON frozen) 40)
(= (delivered NORTH_ROCKHAMPTON frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676)
...
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_BLACKWATER) 240) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153)
...
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_BLACKWATER) 205) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118)
	)
...
(= (delivered NORTH_ROCKHAMPTON ambient) (demand NORTH_ROCKHAMPTON ambient)) (= (delivered NORTH_ROCKHAMPTON frozen) (demand NORTH_ROCKHAMPTON frozen))
	...
	(:bounds
		...
		(demand - int[0..74]) ;; between 0 and largest demand of any commodity
