(define (problem kurtz-2013-12-09)
...
(= (demand GLADSTONE_VALLEY ambient) 115)
(= (outstanding GLADSTONE_VALLEY ambient) 115)
...
(= (demand EMERALD ambient) 46)
(= (outstanding EMERALD ambient) 46)
