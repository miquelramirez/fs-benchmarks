(define (problem kurtz-2014-05-29)
...
(= (demand GLADSTONE_VALLEY ambient) 103)
(= (outstanding GLADSTONE_VALLEY ambient) 103)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..103]) ;; between 0 and largest demand of any commodity
