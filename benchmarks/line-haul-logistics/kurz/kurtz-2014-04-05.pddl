(define (problem kurtz-2014-04-05)
	...
	(:objects
		...
		EMERALD GLADSTONE_VALLEY NORTH_ROCKHAMPTON BLACKWATER BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON loc_BLACKWATER loc_BILOELA - location
	)
...
(= (demand EMERALD ambient) 26)
(= (outstanding EMERALD ambient) 26)
...
(= (demand GLADSTONE_VALLEY ambient) 60)
(= (outstanding GLADSTONE_VALLEY ambient) 60)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 9)
(= (outstanding GLADSTONE_VALLEY frozen) 9)
(= (delivered GLADSTONE_VALLEY frozen) 0)
(= (site NORTH_ROCKHAMPTON) loc_NORTH_ROCKHAMPTON)
(= (demand NORTH_ROCKHAMPTON ambient) 71)
(= (outstanding NORTH_ROCKHAMPTON ambient) 71)
(= (delivered NORTH_ROCKHAMPTON ambient) 0)
(= (demand NORTH_ROCKHAMPTON frozen) 54)
(= (outstanding NORTH_ROCKHAMPTON frozen) 54)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_BILOELA) 605)
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281) (= (dist loc_EMERALD loc_BLACKWATER) 79) (= (dist loc_EMERALD loc_BILOELA) 315)
...
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153) (= (dist loc_BILOELA loc_BLACKWATER) 240)
	)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient))
	...
	(:bounds
		...
		(demand - int[0..71]) ;; between 0 and largest demand of any commodity
