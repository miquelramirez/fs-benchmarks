(define (problem kurtz-2014-04-25)
...
(= (demand GLADSTONE_VALLEY ambient) 23)
(= (outstanding GLADSTONE_VALLEY ambient) 23)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 11)
(= (outstanding GLADSTONE_VALLEY frozen) 11)
...
(= (demand EMERALD ambient) 6)
(= (outstanding EMERALD ambient) 6)
...
(= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..23]) ;; between 0 and largest demand of any commodity
