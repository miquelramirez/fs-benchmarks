(define (problem kurtz-2013-08-31)
	...
	(:objects
		...
		EMERALD GLADSTONE_VALLEY NORTH_ROCKHAMPTON BILOELA BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON loc_BILOELA loc_BLACKWATER - location
	)
...
(= (demand NORTH_ROCKHAMPTON ambient) 131)
(= (outstanding NORTH_ROCKHAMPTON ambient) 131)
(= (delivered NORTH_ROCKHAMPTON ambient) 0)
(= (demand NORTH_ROCKHAMPTON frozen) 41)
(= (outstanding NORTH_ROCKHAMPTON frozen) 41)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_BLACKWATER) 844)
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281) (= (dist loc_EMERALD loc_BILOELA) 315) (= (dist loc_EMERALD loc_BLACKWATER) 79)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..131]) ;; between 0 and largest demand of any commodity
