(define (problem kurtz-2014-07-09)
...
(= (demand GLADSTONE_VALLEY ambient) 96)
(= (outstanding GLADSTONE_VALLEY ambient) 96)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 57)
(= (outstanding GLADSTONE_VALLEY frozen) 57)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..96]) ;; between 0 and largest demand of any commodity
