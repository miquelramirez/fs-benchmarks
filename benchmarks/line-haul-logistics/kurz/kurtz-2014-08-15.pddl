(define (problem kurtz-2014-08-15)
...
(= (demand GLADSTONE_VALLEY frozen) 89)
(= (outstanding GLADSTONE_VALLEY frozen) 89)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..89]) ;; between 0 and largest demand of any commodity
