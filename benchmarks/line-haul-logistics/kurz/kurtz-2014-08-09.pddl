(define (problem kurtz-2014-08-09)
	...
	(:objects
		...
		NORTH_ROCKHAMPTON EMERALD BILOELA GLADSTONE_VALLEY - customer
		ambient frozen - commodity
		loc_BRDC loc_NORTH_ROCKHAMPTON loc_EMERALD loc_BILOELA loc_GLADSTONE_VALLEY - location
	)
...
(= (delivered GLADSTONE_VALLEY frozen) 0)
		...
		(= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565)
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118)
