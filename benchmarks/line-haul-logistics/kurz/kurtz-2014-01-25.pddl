(define (problem kurtz-2014-01-25)
	...
	(:objects
		...
		BILOELA GLADSTONE_VALLEY BLACKWATER EMERALD NORTH_ROCKHAMPTON - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_GLADSTONE_VALLEY loc_BLACKWATER loc_EMERALD loc_NORTH_ROCKHAMPTON - location
	)
...
(= (demand GLADSTONE_VALLEY ambient) 47)
(= (outstanding GLADSTONE_VALLEY ambient) 47)
...
(= (demand NORTH_ROCKHAMPTON frozen) 50)
(= (outstanding NORTH_ROCKHAMPTON frozen) 50)
(= (delivered NORTH_ROCKHAMPTON frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676)
...
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118)
