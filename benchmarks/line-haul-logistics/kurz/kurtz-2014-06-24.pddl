(define (problem kurtz-2014-06-24)
...
(= (demand GLADSTONE_VALLEY ambient) 51)
(= (outstanding GLADSTONE_VALLEY ambient) 51)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 69)
(= (outstanding GLADSTONE_VALLEY frozen) 69)
