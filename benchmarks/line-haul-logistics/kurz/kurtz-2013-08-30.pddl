(define (problem kurtz-2013-08-30)
...
(= (demand GLADSTONE_VALLEY frozen) 118)
(= (outstanding GLADSTONE_VALLEY frozen) 118)
...
(= (demand BLACKWATER frozen) 8)
(= (outstanding BLACKWATER frozen) 8)
...
(= (demand EMERALD ambient) 43)
(= (outstanding EMERALD ambient) 43)
...
(= (delivered EMERALD ambient) (demand EMERALD ambient)) (= (delivered EMERALD frozen) (demand EMERALD frozen))
	...
	(:bounds
		...
		(demand - int[0..118]) ;; between 0 and largest demand of any commodity
