(define (problem kurtz-2013-11-21)
...
(= (demand EMERALD frozen) 40)
(= (outstanding EMERALD frozen) 40)
(= (delivered EMERALD frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 110)
(= (outstanding GLADSTONE_VALLEY ambient) 110)
...
(= (demand BLACKWATER ambient) 23)
(= (outstanding BLACKWATER ambient) 23)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient)) (= (delivered BILOELA frozen) (demand BILOELA frozen))
	...
	(:bounds
		...
		(demand - int[0..110]) ;; between 0 and largest demand of any commodity
