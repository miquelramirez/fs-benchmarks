(define (problem kurtz-2013-12-23)
	...
	(:objects
		...
		BLACKWATER GLADSTONE_VALLEY BILOELA EMERALD - customer
		ambient frozen - commodity
		loc_BRDC loc_BLACKWATER loc_GLADSTONE_VALLEY loc_BILOELA loc_EMERALD - location
	)
...
(= (delivered EMERALD frozen) 0)
		...
		(= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_EMERALD) 869)
