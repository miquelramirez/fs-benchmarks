(define (problem kurtz-2013-11-08)
	...
	(:objects
		...
		BILOELA GLADSTONE_VALLEY BLACKWATER EMERALD - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_GLADSTONE_VALLEY loc_BLACKWATER loc_EMERALD - location
	)
...
(= (demand BILOELA ambient) 22)
(= (outstanding BILOELA ambient) 22)
...
(= (demand GLADSTONE_VALLEY ambient) 109)
(= (outstanding GLADSTONE_VALLEY ambient) 109)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 105)
(= (outstanding GLADSTONE_VALLEY frozen) 105)
...
(= (demand EMERALD ambient) 53)
(= (outstanding EMERALD ambient) 53)
(= (delivered EMERALD ambient) 0)
(= (demand EMERALD frozen) 54)
(= (outstanding EMERALD frozen) 54)
(= (delivered EMERALD frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_EMERALD) 869)
...
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_BILOELA) 240) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297) (= (dist loc_BLACKWATER loc_EMERALD) 79)
