(define (problem kurtz-2013-11-27)
...
(= (demand GLADSTONE_VALLEY ambient) 120)
(= (outstanding GLADSTONE_VALLEY ambient) 120)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..120]) ;; between 0 and largest demand of any commodity
