(define (problem kurtz-2014-04-16)
	...
	(:objects
		...
		GLADSTONE_VALLEY EMERALD BILOELA BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_GLADSTONE_VALLEY loc_EMERALD loc_BILOELA loc_BLACKWATER - location
	)
...
(= (demand GLADSTONE_VALLEY frozen) 115)
(= (outstanding GLADSTONE_VALLEY frozen) 115)
...
(= (demand EMERALD frozen) 63)
(= (outstanding EMERALD frozen) 63)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_BLACKWATER) 844)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..115]) ;; between 0 and largest demand of any commodity
