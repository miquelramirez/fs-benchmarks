(define (problem kurtz-2013-12-12)
...
(= (demand GLADSTONE_VALLEY ambient) 127)
(= (outstanding GLADSTONE_VALLEY ambient) 127)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..127]) ;; between 0 and largest demand of any commodity
