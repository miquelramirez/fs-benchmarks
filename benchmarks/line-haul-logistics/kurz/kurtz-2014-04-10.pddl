(define (problem kurtz-2014-04-10)
	...
	(:objects
		...
		GLADSTONE_VALLEY BILOELA BLACKWATER EMERALD - customer
		ambient frozen - commodity
		loc_BRDC loc_GLADSTONE_VALLEY loc_BILOELA loc_BLACKWATER loc_EMERALD - location
	)
...
(= (demand GLADSTONE_VALLEY ambient) 132)
(= (outstanding GLADSTONE_VALLEY ambient) 132)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 85)
(= (outstanding GLADSTONE_VALLEY frozen) 85)
...
(= (demand BLACKWATER frozen) 16)
(= (outstanding BLACKWATER frozen) 16)
...
(= (demand EMERALD frozen) 39)
(= (outstanding EMERALD frozen) 39)
(= (delivered EMERALD frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_EMERALD) 869)
...
(= (delivered EMERALD ambient) (demand EMERALD ambient)) (= (delivered EMERALD frozen) (demand EMERALD frozen))
	...
	(:bounds
		...
		(demand - int[0..132]) ;; between 0 and largest demand of any commodity
