(define (problem kurtz-2014-03-21)
	...
	(:objects
		...
		BILOELA BLACKWATER EMERALD GLADSTONE_VALLEY - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_BLACKWATER loc_EMERALD loc_GLADSTONE_VALLEY - location
	)
...
(= (demand BILOELA ambient) 21)
(= (outstanding BILOELA ambient) 21)
...
(= (demand BLACKWATER ambient) 26)
(= (outstanding BLACKWATER ambient) 26)
(= (delivered BLACKWATER ambient) 0)
(= (demand BLACKWATER frozen) 11)
(= (outstanding BLACKWATER frozen) 11)
...
(= (demand EMERALD frozen) 51)
(= (outstanding EMERALD frozen) 51)
(= (delivered EMERALD frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 102)
(= (outstanding GLADSTONE_VALLEY ambient) 102)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 101)
(= (outstanding GLADSTONE_VALLEY frozen) 101)
(= (delivered GLADSTONE_VALLEY frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565)
...
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_BILOELA) 240) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297)
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_BILOELA) 315) (= (dist loc_EMERALD loc_BLACKWATER) 79) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372)
	)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..102]) ;; between 0 and largest demand of any commodity
