(define (problem kurtz-2014-07-12)
...
(= (demand NORTH_ROCKHAMPTON ambient) 188)
(= (outstanding NORTH_ROCKHAMPTON ambient) 188)
(= (delivered NORTH_ROCKHAMPTON ambient) 0)
(= (demand NORTH_ROCKHAMPTON frozen) 46)
(= (outstanding NORTH_ROCKHAMPTON frozen) 46)
...
(= (demand GLADSTONE_VALLEY ambient) 59)
(= (outstanding GLADSTONE_VALLEY ambient) 59)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient))
	...
	(:bounds
		...
		(demand - int[0..188]) ;; between 0 and largest demand of any commodity
