(define (problem kurtz-2013-12-24)
...
(= (demand EMERALD ambient) 12)
(= (outstanding EMERALD ambient) 12)
(= (delivered EMERALD ambient) 0)
(= (demand EMERALD frozen) 21)
(= (outstanding EMERALD frozen) 21)
(= (delivered EMERALD frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 3)
(= (outstanding GLADSTONE_VALLEY ambient) 3)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 43)
(= (outstanding GLADSTONE_VALLEY frozen) 43)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient)) (= (delivered BILOELA frozen) (demand BILOELA frozen))
	...
	(:bounds
		...
		(demand - int[0..43]) ;; between 0 and largest demand of any commodity
