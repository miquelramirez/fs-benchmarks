(define (problem kurtz-2014-07-11)
...
(= (demand GLADSTONE_VALLEY ambient) 114)
(= (outstanding GLADSTONE_VALLEY ambient) 114)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 92)
(= (outstanding GLADSTONE_VALLEY frozen) 92)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient)) (= (delivered BILOELA frozen) (demand BILOELA frozen))
	...
	(:bounds
		...
		(demand - int[0..114]) ;; between 0 and largest demand of any commodity
