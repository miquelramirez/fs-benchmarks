(define (problem kurtz-2013-10-31)
	...
	(:objects
		...
		GLADSTONE_VALLEY BLACKWATER EMERALD BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_GLADSTONE_VALLEY loc_BLACKWATER loc_EMERALD loc_BILOELA - location
	)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605)
