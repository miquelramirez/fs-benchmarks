(define (problem kurtz-2013-12-20)
	...
	(:objects
		...
		BILOELA BLACKWATER GLADSTONE_VALLEY EMERALD - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_BLACKWATER loc_GLADSTONE_VALLEY loc_EMERALD - location
	)
...
(= (demand GLADSTONE_VALLEY ambient) 135)
(= (outstanding GLADSTONE_VALLEY ambient) 135)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 116)
(= (outstanding GLADSTONE_VALLEY frozen) 116)
(= (delivered GLADSTONE_VALLEY frozen) 0)
(= (site EMERALD) loc_EMERALD)
(= (demand EMERALD ambient) 59)
(= (outstanding EMERALD ambient) 59)
(= (delivered EMERALD ambient) 0)
(= (demand EMERALD frozen) 74)
(= (outstanding EMERALD frozen) 74)
(= (delivered EMERALD frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_EMERALD) 869)
