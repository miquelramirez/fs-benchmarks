(define (problem kurtz-2013-09-13)
...
(= (demand GLADSTONE_VALLEY frozen) 119)
(= (outstanding GLADSTONE_VALLEY frozen) 119)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..119]) ;; between 0 and largest demand of any commodity
