(define (problem kurtz-2014-02-02)
...
(= (demand GLADSTONE_VALLEY ambient) 0)
(= (outstanding GLADSTONE_VALLEY ambient) 0)
...
(= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
