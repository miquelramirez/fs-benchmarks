(define (problem kurtz-2014-04-26)
	...
	(:objects
		...
		NORTH_ROCKHAMPTON EMERALD GLADSTONE_VALLEY BLACKWATER BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_NORTH_ROCKHAMPTON loc_EMERALD loc_GLADSTONE_VALLEY loc_BLACKWATER loc_BILOELA - location
	)
...
(= (demand NORTH_ROCKHAMPTON ambient) 70)
(= (outstanding NORTH_ROCKHAMPTON ambient) 70)
(= (delivered NORTH_ROCKHAMPTON ambient) 0)
(= (demand NORTH_ROCKHAMPTON frozen) 107)
(= (outstanding NORTH_ROCKHAMPTON frozen) 107)
(= (delivered NORTH_ROCKHAMPTON frozen) 0)
(= (site EMERALD) loc_EMERALD)
(= (demand EMERALD ambient) 33)
(= (outstanding EMERALD ambient) 33)
...
(= (demand GLADSTONE_VALLEY ambient) 66)
(= (outstanding GLADSTONE_VALLEY ambient) 66)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 48)
(= (outstanding GLADSTONE_VALLEY frozen) 48)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_BILOELA) 605)
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118) (= (dist loc_NORTH_ROCKHAMPTON loc_BLACKWATER) 205) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153)
...
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297) (= (dist loc_BLACKWATER loc_BILOELA) 240)
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_BLACKWATER) 240)
	)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient)) (= (delivered BILOELA frozen) (demand BILOELA frozen))
	...
	(:bounds
		...
		(demand - int[0..107]) ;; between 0 and largest demand of any commodity
