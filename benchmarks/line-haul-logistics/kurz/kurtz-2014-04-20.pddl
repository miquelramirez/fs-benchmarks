(define (problem kurtz-2014-04-20)
...
(= (demand EMERALD frozen) 23)
(= (outstanding EMERALD frozen) 23)
...
(= (demand GLADSTONE_VALLEY frozen) 37)
(= (outstanding GLADSTONE_VALLEY frozen) 37)
...
(= (delivered BILOELA frozen) (demand BILOELA frozen))
	...
	(:bounds
		...
		(demand - int[0..37]) ;; between 0 and largest demand of any commodity
