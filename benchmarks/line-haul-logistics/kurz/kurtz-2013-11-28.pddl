(define (problem kurtz-2013-11-28)
	...
	(:objects
		...
		EMERALD BLACKWATER GLADSTONE_VALLEY BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_BLACKWATER loc_GLADSTONE_VALLEY loc_BILOELA - location
	)
...
(= (demand GLADSTONE_VALLEY ambient) 105)
(= (outstanding GLADSTONE_VALLEY ambient) 105)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 86)
(= (outstanding GLADSTONE_VALLEY frozen) 86)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605)
