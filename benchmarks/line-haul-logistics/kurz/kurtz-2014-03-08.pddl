(define (problem kurtz-2014-03-08)
	...
	(:objects
		...
		EMERALD NORTH_ROCKHAMPTON GLADSTONE_VALLEY BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY loc_BILOELA - location
	)
...
(= (demand GLADSTONE_VALLEY frozen) 23)
(= (outstanding GLADSTONE_VALLEY frozen) 23)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605)
...
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137)
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_EMERALD) 315) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137)
	)
