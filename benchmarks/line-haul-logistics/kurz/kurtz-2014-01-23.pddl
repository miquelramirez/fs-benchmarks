(define (problem kurtz-2014-01-23)
...
(= (demand BLACKWATER ambient) 34)
(= (outstanding BLACKWATER ambient) 34)
(= (delivered BLACKWATER ambient) 0)
(= (demand BLACKWATER frozen) 21)
(= (outstanding BLACKWATER frozen) 21)
(= (delivered BLACKWATER frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 99)
(= (outstanding GLADSTONE_VALLEY ambient) 99)
...
(= (delivered GLADSTONE_VALLEY ambient) (demand GLADSTONE_VALLEY ambient)) (= (delivered GLADSTONE_VALLEY frozen) (demand GLADSTONE_VALLEY frozen))
	...
	(:bounds
		...
		(demand - int[0..99]) ;; between 0 and largest demand of any commodity
