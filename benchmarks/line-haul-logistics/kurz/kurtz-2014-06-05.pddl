(define (problem kurtz-2014-06-05)
	...
	(:objects
		...
		EMERALD GLADSTONE_VALLEY BLACKWATER BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_EMERALD loc_GLADSTONE_VALLEY loc_BLACKWATER loc_BILOELA - location
	)
...
(= (demand GLADSTONE_VALLEY frozen) 75)
(= (outstanding GLADSTONE_VALLEY frozen) 75)
(= (delivered GLADSTONE_VALLEY frozen) 0)
(= (site BLACKWATER) loc_BLACKWATER)
(= (demand BLACKWATER ambient) 31)
(= (outstanding BLACKWATER ambient) 31)
(= (delivered BLACKWATER ambient) 0)
(= (demand BLACKWATER frozen) 20)
(= (outstanding BLACKWATER frozen) 20)
(= (delivered BLACKWATER frozen) 0)
(= (site BILOELA) loc_BILOELA)
(= (demand BILOELA ambient) 15)
(= (outstanding BILOELA ambient) 15)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_BILOELA) 605)
