(define (problem kurtz-2013-09-26)
	...
	(:objects
		...
		BILOELA GLADSTONE_VALLEY EMERALD BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_GLADSTONE_VALLEY loc_EMERALD loc_BLACKWATER - location
	)
...
(= (demand BILOELA ambient) 26)
(= (outstanding BILOELA ambient) 26)
(= (delivered BILOELA ambient) 0)
(= (demand BILOELA frozen) 31)
(= (outstanding BILOELA frozen) 31)
(= (delivered BILOELA frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 138)
(= (outstanding GLADSTONE_VALLEY ambient) 138)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 97)
(= (outstanding GLADSTONE_VALLEY frozen) 97)
(= (delivered GLADSTONE_VALLEY frozen) 0)
(= (site EMERALD) loc_EMERALD)
(= (demand EMERALD ambient) 41)
(= (outstanding EMERALD ambient) 41)
...
(= (demand BLACKWATER ambient) 27)
(= (outstanding BLACKWATER ambient) 27)
...
(= (delivered BLACKWATER frozen) 0)
		...
		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BLACKWATER) 844)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..138]) ;; between 0 and largest demand of any commodity
