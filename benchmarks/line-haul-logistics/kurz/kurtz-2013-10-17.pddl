(define (problem kurtz-2013-10-17)
...
(= (demand GLADSTONE_VALLEY ambient) 87)
(= (outstanding GLADSTONE_VALLEY ambient) 87)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 80)
(= (outstanding GLADSTONE_VALLEY frozen) 80)
