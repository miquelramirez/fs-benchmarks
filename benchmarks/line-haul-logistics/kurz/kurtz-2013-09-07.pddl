(define (problem kurtz-2013-09-07)
	...
	(:objects
		...
		NORTH_ROCKHAMPTON EMERALD GLADSTONE_VALLEY BILOELA BLACKWATER - customer
		ambient frozen - commodity
		loc_BRDC loc_NORTH_ROCKHAMPTON loc_EMERALD loc_GLADSTONE_VALLEY loc_BILOELA loc_BLACKWATER - location
	)
...
(= (demand NORTH_ROCKHAMPTON ambient) 75)
(= (outstanding NORTH_ROCKHAMPTON ambient) 75)
(= (delivered NORTH_ROCKHAMPTON ambient) 0)
(= (demand NORTH_ROCKHAMPTON frozen) 70)
(= (outstanding NORTH_ROCKHAMPTON frozen) 70)
...
(= (demand EMERALD frozen) 12)
(= (outstanding EMERALD frozen) 12)
(= (delivered EMERALD frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 65)
(= (outstanding GLADSTONE_VALLEY ambient) 65)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 47)
(= (outstanding GLADSTONE_VALLEY frozen) 47)
...
(= (demand BLACKWATER frozen) 7)
(= (outstanding BLACKWATER frozen) 7)
(= (delivered BLACKWATER frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_BLACKWATER) 844)
...
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..75]) ;; between 0 and largest demand of any commodity
