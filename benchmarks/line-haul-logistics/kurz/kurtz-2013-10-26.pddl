(define (problem kurtz-2013-10-26)
...
(= (demand NORTH_ROCKHAMPTON ambient) 77)
(= (outstanding NORTH_ROCKHAMPTON ambient) 77)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient))
	...
	(:bounds
		...
		(demand - int[0..77]) ;; between 0 and largest demand of any commodity
