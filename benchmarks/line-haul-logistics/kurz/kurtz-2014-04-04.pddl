(define (problem kurtz-2014-04-04)
...
(= (demand BLACKWATER frozen) 10)
(= (outstanding BLACKWATER frozen) 10)
...
(= (demand GLADSTONE_VALLEY frozen) 93)
(= (outstanding GLADSTONE_VALLEY frozen) 93)
