(define (problem kurtz-2014-01-11)
	...
	(:objects
		...
		BILOELA EMERALD BLACKWATER GLADSTONE_VALLEY NORTH_ROCKHAMPTON - customer
		ambient frozen - commodity
		loc_BRDC loc_BILOELA loc_EMERALD loc_BLACKWATER loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON - location
	)
...
(= (demand GLADSTONE_VALLEY ambient) 48)
(= (outstanding GLADSTONE_VALLEY ambient) 48)
...
(= (demand NORTH_ROCKHAMPTON frozen) 44)
(= (outstanding NORTH_ROCKHAMPTON frozen) 44)
(= (delivered NORTH_ROCKHAMPTON frozen) 0)

		(= (day_cost) 0)

		(= (dist loc_BRDC loc_BILOELA) 605) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676)
...
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_BILOELA) 315) (= (dist loc_EMERALD loc_BLACKWATER) 79) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_BILOELA) 240) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205)
...
(= (dist loc_NORTH_ROCKHAMPTON loc_BRDC) 675) (= (dist loc_NORTH_ROCKHAMPTON loc_BILOELA) 153) (= (dist loc_NORTH_ROCKHAMPTON loc_EMERALD) 281) (= (dist loc_NORTH_ROCKHAMPTON loc_BLACKWATER) 205) (= (dist loc_NORTH_ROCKHAMPTON loc_GLADSTONE_VALLEY) 118)
	)
