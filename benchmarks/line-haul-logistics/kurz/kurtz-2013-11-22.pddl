(define (problem kurtz-2013-11-22)
...
(= (demand BILOELA frozen) 16)
(= (outstanding BILOELA frozen) 16)
...
(= (demand GLADSTONE_VALLEY ambient) 95)
(= (outstanding GLADSTONE_VALLEY ambient) 95)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 106)
(= (outstanding GLADSTONE_VALLEY frozen) 106)
...
(= (delivered BLACKWATER ambient) (demand BLACKWATER ambient)) (= (delivered BLACKWATER frozen) (demand BLACKWATER frozen))
	...
	(:bounds
		...
		(demand - int[0..106]) ;; between 0 and largest demand of any commodity
