(define (problem kurtz-2013-09-28)
	...
	(:objects
		...
		GLADSTONE_VALLEY BLACKWATER NORTH_ROCKHAMPTON EMERALD BILOELA - customer
		ambient frozen - commodity
		loc_BRDC loc_GLADSTONE_VALLEY loc_BLACKWATER loc_NORTH_ROCKHAMPTON loc_EMERALD loc_BILOELA - location
	)
...
(= (demand GLADSTONE_VALLEY ambient) 68)
(= (outstanding GLADSTONE_VALLEY ambient) 68)
...
(= (demand NORTH_ROCKHAMPTON ambient) 84)
(= (outstanding NORTH_ROCKHAMPTON ambient) 84)
(= (delivered NORTH_ROCKHAMPTON ambient) 0)
(= (demand NORTH_ROCKHAMPTON frozen) 71)
(= (outstanding NORTH_ROCKHAMPTON frozen) 71)
(= (delivered NORTH_ROCKHAMPTON frozen) 0)
(= (site EMERALD) loc_EMERALD)
(= (demand EMERALD ambient) 35)
(= (outstanding EMERALD ambient) 35)
...
(= (delivered BILOELA frozen) 0)
		...
		(= (dist loc_BRDC loc_GLADSTONE_VALLEY) 565) (= (dist loc_BRDC loc_BLACKWATER) 844) (= (dist loc_BRDC loc_NORTH_ROCKHAMPTON) 676) (= (dist loc_BRDC loc_EMERALD) 869) (= (dist loc_BRDC loc_BILOELA) 605)
(= (dist loc_GLADSTONE_VALLEY loc_BRDC) 565) (= (dist loc_GLADSTONE_VALLEY loc_BLACKWATER) 297) (= (dist loc_GLADSTONE_VALLEY loc_NORTH_ROCKHAMPTON) 118) (= (dist loc_GLADSTONE_VALLEY loc_EMERALD) 372) (= (dist loc_GLADSTONE_VALLEY loc_BILOELA) 137)
(= (dist loc_BLACKWATER loc_BRDC) 844) (= (dist loc_BLACKWATER loc_GLADSTONE_VALLEY) 297) (= (dist loc_BLACKWATER loc_NORTH_ROCKHAMPTON) 205) (= (dist loc_BLACKWATER loc_EMERALD) 79) (= (dist loc_BLACKWATER loc_BILOELA) 240)
...
(= (dist loc_EMERALD loc_BRDC) 869) (= (dist loc_EMERALD loc_GLADSTONE_VALLEY) 372) (= (dist loc_EMERALD loc_BLACKWATER) 79) (= (dist loc_EMERALD loc_NORTH_ROCKHAMPTON) 281) (= (dist loc_EMERALD loc_BILOELA) 315)
(= (dist loc_BILOELA loc_BRDC) 605) (= (dist loc_BILOELA loc_GLADSTONE_VALLEY) 137) (= (dist loc_BILOELA loc_BLACKWATER) 240) (= (dist loc_BILOELA loc_NORTH_ROCKHAMPTON) 153) (= (dist loc_BILOELA loc_EMERALD) 315)
	)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient)) (= (delivered BILOELA frozen) (demand BILOELA frozen))
	...
	(:bounds
		...
		(demand - int[0..84]) ;; between 0 and largest demand of any commodity
