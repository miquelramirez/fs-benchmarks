(define (problem kurtz-2013-10-06)
...
(= (demand EMERALD frozen) 29)
(= (outstanding EMERALD frozen) 29)
(= (delivered EMERALD frozen) 0)
(= (site GLADSTONE_VALLEY) loc_GLADSTONE_VALLEY)
(= (demand GLADSTONE_VALLEY ambient) 7)
(= (outstanding GLADSTONE_VALLEY ambient) 7)
(= (delivered GLADSTONE_VALLEY ambient) 0)
(= (demand GLADSTONE_VALLEY frozen) 54)
(= (outstanding GLADSTONE_VALLEY frozen) 54)
...
(= (demand BILOELA ambient) 30)
(= (outstanding BILOELA ambient) 30)
...
(= (delivered BILOELA ambient) (demand BILOELA ambient)) (= (delivered BILOELA frozen) (demand BILOELA frozen))
	...
	(:bounds
		...
		(demand - int[0..54]) ;; between 0 and largest demand of any commodity
